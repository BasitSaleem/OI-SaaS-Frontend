...
const FeaturesCards = [
  {
    ...
    imageSrc: "/assets/features-page/purchases-page/features-section/centralized-purchase.webp",
  },
  {
    id: 2,
    title: "Supplier Directory & Management",
    description: "Keep all your supplier records organized like contact information and past transactions. Having this complete history makes it much easier and more reliable to manage your relationships with them.",
    imageSrc: "/assets/features-page/purchases-page/features-section/supplier-directory.webp",
  },
  {
    id: 3,
    title: "Automated Purchase Orders",
    description: "The system automatically generates and sends purchase orders based on stock levels and sales trends, preventing inventory shortages and missed sales, a key function of our Automated Purchase Management Solution.",
    imageSrc: "/assets/features-page/purchases-page/features-section/automated-purchase.webp",
  },
  {
    id: 4,
    title: "Bill Management and Tracking",
    description: "This function allows users to easily create and manage bills and purchase orders. Get instant access to all financial data for transparent and simple accounting.",
    imageSrc: "/assets/features-page/purchases-page/features-section/bill-management.webp",
  },
  {
    id: 5,
    title: "Purchase Approval Workflow",
    description: "Easily define approval steps for purchases. This guarantees compliance and accountability which gives you control without creating any hurdles.",
    imageSrc: "/assets/features-page/purchases-page/features-section/purchase-approval.webp",
  },
  {
    id: 6,
    title: "Import & Export Options",
    description: "Quickly imports data in bulk and exports reports to Excel. This is used for accounting and audits. Get the data flexibility that perfectly adapts to your workflow.",
    imageSrc: "/assets/features-page/purchases-page/features-section/import-option.webp",
  },
  {
    id: 7,
    title: "Comprehensive Dashboard",
    description: "Gain real-time visibility into purchase activity, supplier performance and pending bills. This is the power of a dedicated Purchase Tracking Software.",
    imageSrc: "/assets/features-page/people-page/features-section/performance-tracking.webp",
  },
  {
    id: 8,
    title: "Search & Filter Options",
    description: "Gain instant, real time clarity! Track all purchase activity, monitor supplier performance, and see pending bills right on a single, easy-to-use, interactive dashboard.",
    imageSrc: "/assets/features-page/sales-order/features-section/filter-option.webp",
  },
  {
    id: 9,
    title: "User-Friendly Interface",
    description: "A clean, interactive design means managing purchases is quick and easy. Spend less time struggling with software and more time improving your business.",
...
const purchasesFaqs = [
  {
    ...
    answer: "The Purchases feature helps you manage suppliers, create purchase orders, record stock receipts, and track costs from a single system. It ensures accurate inventory and better control over spending.",
  },
  {
    id: 2,
    question: "Can I manage multiple suppliers and vendor pricing?",
    answer: "Absolutely. You can add unlimited suppliers, assign vendor-specific prices, track purchase history, and manage outstanding balances easily.",
  },
  {
    id: 3,
    question: "How does your Purchase Management System improve efficiency?",
    answer: "Efficiency is enhanced through the automation of administrative tasks. This includes the automatic generation of purchase orders, the creation of bills and supplier tracking.",
  },
  {
    id: 4,
    question: "Can I integrate purchase management with inventory tracking?",
    answer: "Absolutely. Owners Inventory is designed to integrate fully, synchronizing all purchase data directly with your inventory records.",
  },
  {
    id: 5,
    question: "Is this suitable for multi-location businesses?",
    answer: "Yes. Whether managing a single location or a complex network of branches, Owners Inventory facilitates centralized purchasing control.",
  },
];
        ...
        cards={[
          {
            ...
            description: "We automate your purchase process from receiving items to bill approval, reducing errors and boosting efficiency.",
          },
          {
            icon: "/assets/features-page/purchases-page/why-chose/everything-in-oneplace.svg",
            title: "Everything in One Place",
            description: "Stay updated with precise, real-time data so you can make smarter decisions and always know what's happening in your inventory.",
          },
          {
            icon: "/assets/features-page/purchases-page/why-chose/smarter-decision.svg",
            title: "Smarter Decisions, Faster",
            description: "Our system gives you real-time analytics and easy dashboards, helping you instantly see trends and supplier performance for faster decisions.",
          },
          {
            icon: "/assets/features-page/purchases-page/why-chose/grow-business.svg",
            title: "Grows With Your Business",
            description: "Whether you're a small team or a large operation, Owners Inventory scales effortlessly and adapts to your business without any hassle.",
          },
          {
            icon: "/assets/features-page/purchases-page/why-chose/dedicated-support.svg",
            title: "Dedicated Support, 24/7",
            description: "Our dedicated support team is available 24/7, ensuring your purchasing operations run smoothly without interruption.",
          }, 
        ]}

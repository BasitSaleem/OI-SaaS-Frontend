...
const heroBanner = "https://d2qlv5xtew5ayb.cloudfront.net/assets/industries-pages/furniture-store-pos/furniture-hero-banner.webp";
    ...
    <>
      ...
      <div>
        <SubIndustriesHero
          ...
          description="Owners Inventory is a [POS system](/features/pos) that enables you to run your furniture store accurately, fast, and in full control. Order large quantities, manage custom orders, deliveries and payments all within a single intelligent system. All sales and stock movements remain updated in real time."
          image={heroBanner}

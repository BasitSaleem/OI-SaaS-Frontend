    ...
    <>
      ...
      <div>
        <SubIndustriesHero
          ...
          description="Pet stores must constantly manage their stock of food, grooming products, toys, health products, and other essentials while maintaining customer trust and encouraging repeat purchases. Owners Inventory software offers a dedicated [pet store point of sale solution](/features/pos) to monitor real-time inventory, speed up the checkout process and accurately manage all products."
          image={heroBanner}

    ...
    <>
      ...
      <div>
        ...
        <SecurityCompliance
          ...
          secondDescription="Payment data is protected through end-to-end encryption and secure data handling, with built-in security standards that keep card transactions safe and compliant. Your data is automatically backed up to the cloud so your records can be preserved, even if your hardware breaks down. For age-restricted products like tobacco and alcohol, every sale is recorded separately, giving you a clean and organized compliance report that is ready whenever an official check or audit is required."
        />

...
const heroBanner = "https://d2qlv5xtew5ayb.cloudfront.net/assets/industries-pages/pos-hardware/hardware-hero-banner.webp";
const whyChoseBanner = "https://d2qlv5xtew5ayb.cloudfront.net/assets/industries-pages/pos-hardware/why-chose-banner.webp";
    ...
    <>
      ...
      <div>
        ...
        <SecurityCompliance
          ...
          description="An effective inventory system will make sure that all the transactions are properly documented and monitored. The user roles and permissions restrict access to sensitive information, minimizing errors and theft. All data remains fully secured."

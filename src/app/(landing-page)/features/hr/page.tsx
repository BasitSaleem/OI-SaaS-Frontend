...
const heroBanner = "https://d2qlv5xtew5ayb.cloudfront.net/assets/features-page/hero-section-banners/hr-banner.webp";
const whyChoseBanner = "https://d2qlv5xtew5ayb.cloudfront.net/assets/features-page/why-chose-banners/hr-whychose.webp";
import {
  HR_FAQS,
  HR_FEATURES_CARDS,
  HR_INDUSTRIES,

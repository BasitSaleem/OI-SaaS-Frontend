...
const heroBanner = "https://d2qlv5xtew5ayb.cloudfront.net/assets/features-page/integration-page/integration-hero-banner.webp";
const whyChoseBanner = "https://d2qlv5xtew5ayb.cloudfront.net/assets/features-page/integration-page/why-chose-banner.webp";
import {
  INTEGRATION_FAQS,

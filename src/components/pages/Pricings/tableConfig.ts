    ...
    categories: [
      {
        name: 'Key Features',
        features: [
          { name: 'Warehouses', info: true, infoText: "Manage one or more warehouses.", basic: '1', standard: '2', professional: 'Unlimited', premium: 'Unlimited' },
      ...
      },
      {
        name: 'E-COMMERCE',
        features: [
          { name: 'OJ Themes', info: true, infoText: "Customize your website's appearance with pre-built and custom-developed templates.", basic: true, standard: true, professional: true, premium: true },
          ...
          { name: 'Campaigns', info: true, infoText: "Create and manage marketing campaigns to boost sales.", basic: false, standard: true, professional: true, premium: true },
          ...
          { name: 'Collections', info: true, infoText: "Organize products into groups to make browsing easier for customers.", basic: false, standard: true, professional: true, premium: true },
        ]
      },
      {
        name: 'People',
      ...
      },
      {
        ...
        features: [
          { name: 'Point of Sale', info: true, infoText: "Sell products directly with an intuitive POS system.", basic: true, standard: true, professional: true, premium: true },
          { name: 'POS Terminals', info: true, infoText: "Set up physical POS stations for cashier use. Hardware is not included.", basic: '1', standard: '1', professional: '1', premium: '1' },
          { name: 'Invoices', info: true, infoText: "Print & Share/Send professional invoices to customers with ease.", basic: 'Unlimited', standard: 'Unlimited', professional: 'Unlimited', premium: 'Unlimited' },
          { name: 'Quotations', info: true, infoText: "Prepare and send quotes to leads or existing customers.", basic: true, standard: true, professional: true, premium: true },
          { name: 'Sales Orders', info: true, infoText: "Track confirmed customer orders.", basic: true, standard: true, professional: true, premium: true },
          { name: 'Sample Sales', info: true, infoText: "Record and track sample product distribution.", basic: true, standard: true, professional: true, premium: true },
      ...
      },
      {
        ...
        features: [
          ...
          { name: 'Purchases Reports', info: true, infoText: "Monitor purchase trends and metrics.", basic: true, standard: true, professional: true, premium: true },
          { name: 'Decoration', info: true, infoText: "Customize your digital floor layout for ambiance.", basic: true, standard: true, professional: true, premium: true },
        ]
      },
      {
        name: 'GENERAL TOOLS',

              ...
              <div className="relative z-[2] owner-inventory-hero__content flex flex-col items-center justify-center w-full wrapper gap-7 md:gap-8">
                ...
                >
                  <Paragraph className="text-center">
                    Discover expert strategies, industry trends, and practical tips to optimize your inventory management and accelerate business growth.
                  </Paragraph>
                </div>
                ...
                <div
                  ref={searchRef}
                  className="relative z-[9999] flex h-14 w-full max-w-[516px] items-center gap-3 rounded-full border-[2.5px] border-white bg-white/60 px-6 backdrop-blur-[11px]"
                >
                  <svg
                    width="20"
                    height="20"
                  ...
                  <input
                    ...
                    className="relative z-[99999] h-full min-w-0 flex-1 border-0 bg-transparent p-0 text-base font-['Onest'] text-[#231F20] outline-none placeholder:text-[#888] focus:border-0 focus:outline-none focus:ring-0"
                    autoComplete="off"
                    autoCorrect="off"
                    spellCheck={false}
                  />

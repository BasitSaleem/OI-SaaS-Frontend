    ...
    >
      ...
      <div className="relative w-full h-full p-4 md:p-8 flex flex-col justify-between z-10">
        <div className="flex-1 flex flex-col">
          <h3
            className={`lg:text-[32px] md:text-2xl text-xl font-medium font-['Onest'] lg:leading-[130%] md:leading-[135%] leading-[140%] transition-colors ${shouldShowDescription
          ...
          <div
            className={`mt-6 transition-opacity duration-500 ease-in-out ${shouldShowDescription
        ...
        <div
          ...
          className={`bg-white rounded-full h-[60px] hidden md:flex items-center px-2 pl-6 mt-0 md:-mt-96 transition-all duration-300 ease-in-out ${isMobile
        ...
        >
          {link ? (
            ...
            >
              ...
              >
                <ArrowUpRight
                  className={`w-5 h-5 transition-all duration-300 ${isMobile || isHovered
      ...
      <div
        className={`absolute -left-[50px] bottom-[90px] w-[150px] h-[150px] opacity-20 pointer-events-none transition-opacity duration-300 ${isMobile || (isHovered && !isMobile) ? "opacity-0" : "opacity-20"
          }`}
      >
        <div className="absolute inset-0 border-[10px] border-white rounded-full" />
      </div>
      <div
        className={`absolute -left-[45px] bottom-[100px] w-[120px] h-[120px] opacity-10 pointer-events-none transition-opacity duration-300 ${isMobile || (isHovered && !isMobile) ? "opacity-0" : "opacity-10"
          }`}
      >
      ...
      <div
        className={`absolute -right-[80px] -top-[100px] w-[230px] h-[220px] opacity-20 pointer-events-none transition-opacity duration-300 ${isMobile || (isHovered && !isMobile) ? "opacity-0" : "opacity-20"
          }`}
      >

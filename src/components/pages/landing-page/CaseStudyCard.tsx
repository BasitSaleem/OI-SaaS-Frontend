...
export default function CaseStudyCard({
  ...
  return (
    <section>
      ...
      <div className={`h-full grid grid-col-1 md:grid-cols-12 gap-y-8 md:gap-x-5 justify-center items-stretch ${!hideCTA
          ? "items-stretch"
          : "items-start"
        }`}>
        {/* Header */}
        <div className="md:col-span-6 lg:col-span-7  relative z-[10]">
          ...
          <div className="flex flex-col h-full items-end">
            <div className={`bg-[var(--background-halfwhite)] rounded-tl-[20px] rounded-bl-[20px] lg:rounded-tl-[28px] lg:rounded-bl-[28px] p-6 ${!hideCTA
          ...
          <div className="relative ">
            ...
            >
              <Image
                ...
                width={400}
                height={300}
                className={`w-full h-auto object-contain ${hideCTA ? "min-h-[590px] md:min-h-[420px] lg:min-h-[450px] md:max-h-[455px]" : "min-h-[450px]"
                  }`}
              />
            </div>

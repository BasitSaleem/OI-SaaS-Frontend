...
const SmartTools: React.FC<SmartTools> = ({
  ...
  return (
    <section ref={sectionRef} className="">
      <div
        className="w-full px-8 pt-[60px] pb-0 rounded-[20px] lg:rounded-[40px] mt-[28px] md:mt-20 lg:mt-[100px] overflow-hidden bg-cover bg-center"
        style={{
          backgroundImage:
     ...
     transition-colors duration-300"
        ...
        <div className="w-full lg:max-w-[1000px] md:max-w-[760px] xl:max-w-[1065px] bg-transparent px-5 relative z-30 mx-auto mt-8 md:mt-10">
          ...
          {shouldShowImage ? (
            ...
            <video
              className="w-full md:object-cover lazy-video mb-[-70px] lg:mb-[-150px]"
              autoPlay
              muted
              playsInline
              preload="none"

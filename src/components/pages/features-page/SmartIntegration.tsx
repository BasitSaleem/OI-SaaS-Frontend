    ...
    <section className="wrapper">
      <div className="lg:mt-40 md:mt-28 mt-20 flex flex-col gap-12 lg:gap-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <h2 className="font-['Onest'] font-semibold text-[#231F20] text-[27px] sm:text-4xl md:text-[40px] lg:text-5xl leading-9 sm:leading-[48px] lg:leading-[60px] lg:max-w-4xl xl:mb-10 lg:mb-6 mb-5">
            {heading}
          </h2>

...
const IndustriesCallToAction: React.FC<IndustriesCallToAction> = ({
  ...
  return (
    ...
    <div className="wrapper">
      <section
        className="ownerinventory-landing__pos-icons-section xl:px-10 trusted-by-section lg:mt-[100px] md:mt-28 mt-20 flex items-center justify-center rounded-[20px] lg:rounded-[40px] w-[100%] relative z-[100]"
        style={{
...
export default IndustriesCallToAction;

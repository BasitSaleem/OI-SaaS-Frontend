...
const TrustedBySection: React.FC<TrustedBySectionProps> = ({
  ...
  paragraph = "",
  brands = [
    { id: 1, name: "ASK Food Industries", logo: "https://d2qlv5xtew5ayb.cloudfront.net/assets/brands-logo-section/ask-food.svg" },
    { id: 2, name: "Industrial Valco", logo: "https://d2qlv5xtew5ayb.cloudfront.net/assets/brands-logo-section/industrial-valco.svg" },
    { id: 3, name: "Texas Pipe & Supply", logo: "https://d2qlv5xtew5ayb.cloudfront.net/assets/brands-logo-section/texas-pipe.svg" },
    { id: 4, name: "Al-Asif", logo: "https://d2qlv5xtew5ayb.cloudfront.net/assets/brands-logo-section/al-asif.svg" },
    { id: 5, name: "Sportifi", logo: "https://d2qlv5xtew5ayb.cloudfront.net/assets/brands-logo-section/sportifi.svg" },
  ],
}) => {
  return (

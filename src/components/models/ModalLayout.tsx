...
export default function Modal({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-[99999]">
      <div
        data-lenis-prevent
        className="rounded-2xl py-[40px] px-0 md:px-5 w-full h-screen backdrop-blur-md flex items-center justify-center shadow-xl relative bg-contain z-[10000] bg-center bg-no-repeat"

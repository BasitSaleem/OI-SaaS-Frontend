  ...
  return (
    ...
    >
      <button
        ...
        className={`bg-${bgColor} px-3 py-2.5 md:px-5 md:py-3 border border-transparent lg:px-[30px] lg:py-4 flex items-center justify-center text-sm whitespace-nowrap md:text-base font-onest font-semibold text-${textColor}

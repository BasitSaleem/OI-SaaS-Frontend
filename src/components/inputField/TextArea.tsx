        ...
        <div>
            ...
            <div className="relative">
                <textarea
                    // {...register}
                    rows={rows}
                    className="w-[100%] px-4 py-3 outline-0 rounded-[14px] border border-[#D9D9D9] placeholder:text-[16px] text-[#9A9A9A] placeholder:text-[#9A9A9A] appearance-none resize-none"

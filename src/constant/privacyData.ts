export const PRIVACY_POLICY_DATA = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: "Legal Basis for Processing (GDPR and EEA Users)",
        content: [
  ...
  {
    id: "part-2-process-behalf",
    partTitle: "Part II: Information We Process on Your Behalf",
    sections: [
      {
        id: "def-service-data",
        title: "Definition of Service Data",
        content: [
      ...
      {
        id: "role-ownership-data",
        title: "Your Role and Ownership of Data",
        content: [
      ...
      {
        id: "process-service-data",
        title: "How We Process Service Data",
        content: [
      ...
      {
        id: "security-measures-service",
        title: "Security Measures for Service Data",
        content: [
          "We maintain high levels of data security for Service Data. This includes encrypted transmission and storage, strict access control, regular security audits, and continuous monitoring for potential vulnerabilities.",
        ],
      },
      {
        id: "retention-deletion-service",
      ...
      },
      {
        ...
        title: "Data Subject Requests Related to Service Data",
        content: [
  ...
  {
    id: "part-3-general-provisions",
    partTitle: "Part III: General Provisions",
    sections: [
      {
        id: "children-privacy",
      ...
      },
      {
        ...
        title: "Third Party Links and Public Forums",
        content: [
...
export const PRIVACY_SECTIONS = [
  {
    ...
    content:
      "Welcome to Owners Inventory. We value your privacy and are committed to protecting your personal data. This Privacy Policy explains how we collect, use, and safeguard your information when you visit our website or use our services.",
  },
  {
    id: "info-collection",
    title: "2. Information We Collect",
    content:
      "We collect information that you provide directly to us, such as when you create an account, subscribe to our newsletter, or contact us for support. This may include your name, email address, phone number, and business details.",
  },
  {
    id: "info-usage",
    title: "3. How We Use Your Information",
    content:
      "We use the information we collect to provide, maintain, and improve our services, to communicate with you, and to personalize your experience. We may also use your information for marketing purposes, with your consent.",
  },
  {
    id: "data-security",
  ...
  },
  {
    ...
    title: "5. Your Rights",
    content:
      "You have the right to access, correct, or delete your personal information. You may also object to the processing of your data or request that we restrict the processing of your information.",
  },
  {
    id: "cookies",
    title: "6. Cookies",
  ...
  },
  {
    ...
    title: "8. Contact Us",
    content:
      "If you have any questions about this Privacy Policy, please contact us at privacy@ownersinventory.com.",
  },
];

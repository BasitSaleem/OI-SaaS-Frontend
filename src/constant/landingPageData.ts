...
export const HOME_FAQS = [
    {
        ...
        answer: "Our intelligent syncing engine automatically updates stock, pricing and product information in real time across all the linked stores, online marketplaces and POS systems.",
    },
    {
        id: 2,
        question: "Can I integrate Owners Inventory with my e-commerce store?",
        answer: "Yes! It is easy to sell on multiple channels with us, and we provide easy integrations with large e-commerce articles such as Shopify, WooCommerce, and others.",
    },
    {
        id: 3,
        question: "Is Owners Inventory suitable for small businesses?",
        answer: "Absolutely. Our inventory for small business provides small stores up to big chain stores with flexible features and affordable plans depending on the size of your business.",
    },
    {
        id: 4,
        question: "Who is Owners Inventory designed for?",
        answer: "It’s built for retailers, wholesalers, distributors, manufacturers, and ecommerce businesses who want complete control over sales, inventory, staff, and multi-location operations.",
    },
    {
        id: 5,
        question: "What support options are available if I face issues?",
        answer: "We have a committed support staff on chat, email, and phone. We also have some excellent tutorials, video instructions and FAQs so that you can solve problems fast.",
    },
    {
        id: 6,
        question: "Does Owners Inventory support Integrations?",
        answer: "Yes. You can sync products, inventory, orders, customers, and financials across Shopify, WooCommerce, QuickBooks, Stripe, and marketing platforms like HubSpot or Mailchimp.",
    },
];
...
export const LANDING_FEATURES = [
    {
        ...
        videoSrc: "/assets/home-page-images/animations/screen1.webm",
    ...
    },
    {
        ...
        videoSrc: "/assets/home-page-images/animations/screen2.webm",
    ...
    },
    {
        ...
        videoSrc: "/assets/home-page-images/animations/screen3.webm",
    ...
    },
    {
        ...
        videoSrc: "/assets/home-page-images/animations/screen4.webm",

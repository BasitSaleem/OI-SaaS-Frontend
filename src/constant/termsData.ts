export const TERMS_AND_CONDITIONS_DATA = [
  ...
  {
    id: "terms-modifications-service",
...
export const TERMS_SECTIONS = [
  {
    ...
    content:
      "By accessing and using Owners Inventory, you agree to be bound by these Terms and Conditions. If you do not agree to all of these terms, do not use our website or services.",
  },
  {
    id: "terms-use-license",
    title: "2. Use License",
    content:
      "Permission is granted to temporarily download one copy of the materials (information or software) on Owners Inventory's website for personal, non-commercial transitory viewing only.",
  },
  {
    id: "terms-disclaimer",
    title: "3. Disclaimer",
    content:
      "The materials on Owners Inventory's website are provided on an 'as is' basis. Owners Inventory makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability.",
  },
  {
    id: "terms-limitations",
    title: "4. Limitations",
    content:
      "In no event shall Owners Inventory or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on Owners Inventory's website.",
  },
  {
    id: "terms-accuracy",
    title: "5. Accuracy of Materials",
    content:
      "The materials appearing on Owners Inventory's website could include technical, typographical, or photographic errors. Owners Inventory does not warrant that any of the materials on its website are accurate, complete or current.",
  },
  {
    id: "terms-links",
    title: "6. Links",
    content:
      "Owners Inventory has not reviewed all of the sites linked to its website and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by Owners Inventory of the site.",
  },
  {
    id: "terms-modifications",
    title: "7. Modifications",
    content:
      "Owners Inventory may revise these terms of service for its website at any time without notice. By using this website you are agreeing to be bound by the then current version of these terms of service.",
  },
  {

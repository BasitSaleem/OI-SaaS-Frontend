export const INVENTORY_INDUSTRIES = [
    {
        id: 1,
        title: "Retail Stores",
...
export const INVENTORY_FEATURES_CARDS = [
    {
        id: 1,
...
export const INVENTORY_FAQS = [
    {
        id: 1,
        question: " What are inventory operations in Owners Inventory?",
        answer:
    ...
    {
        id: 3,
        question: "How does stock issuing work?",
        answer:

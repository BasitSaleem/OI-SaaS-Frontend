...
export const TOOLS_FEATURES_CARDS = [
  {
    id: 1,
    title: "Activity Log",
    description:
...
export const TOOLS_FAQS = [
  ...
  {
    id: 3,
    question: "Can I get alerts for low or critical stock levels?",
    answer:
...
export const TOOLS_TESTIMONIALS = [
  {
    ...
    image: "https://d2qlv5xtew5ayb.cloudfront.net/assets/features-page/testimonial-images/testinomial-girl26.webp",
  ...
  },
  {
    ...
    image: "https://d2qlv5xtew5ayb.cloudfront.net/assets/features-page/testimonial-images/testinomial-girl27.webp",
...
export const TOOLS_WHY_CHOOSE_CARDS = [
  ...
  },
  {
    ...
    icon: "https://d2qlv5xtew5ayb.cloudfront.net/assets/features-page/general-tools/user-friendly-design.svg",

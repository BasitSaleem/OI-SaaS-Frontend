export const REPORTS_INDUSTRIES = [
  {
    id: 1,
    title: "Retail Stores",
    gradient:
...
export const REPORTS_FEATURES_CARDS = [
  {
    id: 1,
  ...
  },
  {
    ...
    imageSrc:
      "https://d2qlv5xtew5ayb.cloudfront.net/assets/features-page/reports-page/features-section/data-visualization.webp",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    imageSrc:
      "https://d2qlv5xtew5ayb.cloudfront.net/assets/features-page/reports-page/features-section/advance-filtering.webp",
  },
  {
    id: 6,
    ...
    imageSrc:
      "https://d2qlv5xtew5ayb.cloudfront.net/assets/features-page/reports-page/features-section/live-data.webp",
  },
  {
    id: 7,
...
export const REPORTS_FAQS = [
  {
    id: 1,
    question: "What kind of reports can I generate with Owners Inventory?",
    answer:
  ...
  {
    id: 3,
    question: "Can I customize the reports based on my business type?",
    answer:
...
export const REPORTS_TESTIMONIALS = [
  ...
  },
  {
    ...
    image: "https://d2qlv5xtew5ayb.cloudfront.net/assets/features-page/testimonial-images/testinomial-girl16.webp",
...
export const REPORTS_WHY_CHOOSE_CARDS = [
  {
    ...
    icon: "https://d2qlv5xtew5ayb.cloudfront.net/assets/features-page/reports-page/why-chose/actionable-data.svg",
  ...
  },
  {
    ...
    icon: "https://d2qlv5xtew5ayb.cloudfront.net/assets/features-page/reports-page/why-chose/smart-automation.svg",

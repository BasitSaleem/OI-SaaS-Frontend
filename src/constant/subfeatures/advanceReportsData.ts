export const ADVANCE_REPORTS_INDUSTRIES = [
  {
    id: 1,
    title: "Retail Stores",
    gradient:
...
export const ADVANCE_REPORTS_FEATURES_CARDS = [
  {
    id: 1,
...
export const ADVANCE_REPORTS_FAQS = [
  {
    id: 1,
    question: "What is the Advanced Reporting feature?",
    answer:
  ...
  {
    id: 3,
    question: "Does it support inventory aging reports?",
    answer:

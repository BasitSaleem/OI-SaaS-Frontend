...
export const PRODUCT_FEATURES_CARDS = [
  {
    id: 1,
...
export const PRODUCT_FAQS = [
  {
    id: 1,
    question: "What is the Products feature in the Owners Inventory?",
    answer:
  ...
  {
    id: 3,
    question: "Does it support bulk pricing and discount management?",
    answer:

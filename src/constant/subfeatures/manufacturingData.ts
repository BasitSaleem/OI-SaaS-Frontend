...
export const MANUFACTURING_FEATURES_CARDS = [
    {
        id: 1,
...
export const MANUFACTURING_FAQS = [
    {
        id: 1,
        question: "What is manufacturing management in Owners Inventory?",
        answer:
            "Manufacturing management allows you to track production cycles, manage raw materials, monitor machine efficiency, and ensure quality control across all production facilities.",
    },
    {
        id: 2,
        question: "Can I manage Bill of Materials (BOM)?",
        answer:
            "Yes, you can define detailed BOMs for your products, including all components, quantities, and associated production costs.",
    },
    {
        id: 3,
        question: "How does quality inspection work?",
        answer:
            "You can set up inspection points at various stages of production. Inspectors can log results, and the system tracks passes, fails, and rework requirements.",
    },
];

...
export const CONVENIENCE_STORE_UNIFIED_HEADING = "Challenges Convenience Stores Face Daily";

export const CONVENIENCE_STORE_UNIFIED_PARAGRAPH = "These problems are not generic. They are the specific issues that reduce your gross margin, slow your staff, and leave gaps in your records every single day.";
...
export const CONVENIENCE_STORE_UNIFIED_CARDS: UnifiedPlatformCard[] = [
    {
        ...
        description: "Convenience stores operate on small profit, and inventory shrinkage lowers their profit further. When a cashier processes an unusual amount of cancelled transactions, there is often no record attached to those actions. Cash differences build up across shifts, and without proper records, finding the source becomes nearly impossible.",
    },
    {
        id: "2",
        icon: "UnifiedIcon2",
        title: "Age-Restricted Products at Checkout",
        description: "Tobacco, alcohol, and lottery tickets all require an ID check at the point of sale. Doing this manually during a busy counter service period slows the line and increases the chance of a missed check. A single rule violation can put your license at risk, and without a transaction log attached to each age-restricted sale, it becomes hard to prove you followed the rules during an audit. ",
    },
    {
        id: "3",
        icon: "UnifiedIcon3",
    ...
    },
    {
        ...
        description: "Most convenience store owners cannot be on-site at all times. Without remote store monitoring, decisions about stock, staff performance, and daily sales are made on old information. By the time a shift report reaches an absent owner, the opportunity to act on it has already passed.",
    },
    {
        id: "6",
        icon: "UnifiedIcon6",
        title: "No Control Over Pricing Errors",
        description: "Price changes often happen in a convenience store. Without a central price management system, overcharging and undercharging both happen regularly, and both go unnoticed until the numbers stop making sense. ",
    },
];
...
export const CONVENIENCE_STORE_FEATURE_CARDS: FeatureCardData[] = [
    ...
    },
    {
        ...
        imageSrc: "/assets/industries-pages/convenience-store-pos/better-decision.webp",
        buttonLabel: "View Details",
...
export const CONVENIENCE_STORE_KEY_FEATURES_CARDS = [
    {
        ...
        imageSrc: "/assets/industries-pages/convenience-store-pos/key-features-section/key-feature-card1.webp",
    },
    {
        id: 2,
        ...
        imageSrc: "/assets/industries-pages/convenience-store-pos/key-features-section/key-feature-card2.webp",
    },
    {
        id: 3,
        ...
        imageSrc: "/assets/industries-pages/convenience-store-pos/key-features-section/key-feature-card3.webp",
    },
    {
        id: 4,
        ...
        imageSrc: "/assets/industries-pages/convenience-store-pos/key-features-section/key-feature-card4.webp",
    },
    {
        id: 5,
        ...
        imageSrc: "/assets/industries-pages/convenience-store-pos/key-features-section/key-feature-card5.webp",
    },
    {
        id: 6,
        ...
        imageSrc: "/assets/industries-pages/convenience-store-pos/key-features-section/key-feature-card6.webp",
    },
    {
        id: 7,
        ...
        imageSrc: "/assets/industries-pages/convenience-store-pos/key-features-section/key-feature-card7.webp",
    },
    {
        id: 8,
        ...
        imageSrc: "/assets/industries-pages/convenience-store-pos/key-features-section/key-feature-card8.webp",
    },
...
export const CONVENIENCE_STORE_WORKFLOW_DATA = {
    ...
    paragraph: "Our convenience store POS system tracks every stock movement automatically, from the moment products arrive to the moment they leave the shelf, so your inventory count is always accurate and up to date.",
    steps: [
        {
            number: 1,
            title: "Stock Receiving",
            description: "Incoming deliveries are matched against the original purchase order. Quantities are verified on arrival and added to the stock count immediately, so stock level visibility is accurate from the moment goods enter the store."
        },
        {
            number: 2,
        ...
        },
        {
            ...
            description: "Stock level visibility updates with every transaction processed at the counter. You get a low-stock alert automatically if the stock is running low, before it runs out. The system also compares inventory variances between your physical stock and system records, and highlights any differences before it becomes a loss."
        },
        {
            number: 4,
            title: "Supplier and Purchase Orders",
            description: "When stock runs low, purchase orders can be created directly from the dashboard and sent to the relevant supplier. Supplier records, pricing history, and expected delivery times are all stored in one place, making restocking faster and more consistent compared to handling them all manually."
        },
        {
            number: 5,
            title: "Shift-Based Stock Accountability",
            description: "At every shift handover, stock movements are checked against the sales that were recorded during that time. Inventory differences between the physical stock and the system record are flagged immediately so that the issue can be addressed and resolved on the same day."
        },
        {
            number: 6,
            title: "Reporting and Analysis",
            description: "Product reports and daily sales summaries show you which items are selling the most, which ones are not selling at all, and which ones are making the most profit. Peak hour analysis and predicting future demand can help store owners make smarter purchasing decisions on actual sales data, rather than by guessing."
        },
    ]
};
...
export const CONVENIENCE_STORE_FAQS = [
    {
        ...
        answer: "Yes, you can monitor stock levels, track sales, and manage stock transfers across all your branches from a single dashboard without any manual updates."
    },
    {
        id: "2",
        question: "How does the system handle cash accountability at shift change?",
        answer: "At the end of every shift, a cashier reconciliation report is generated automatically, covering each employee's sales and any cash differences so nothing goes unrecorded. "
    },
    {
        id: "3",
        question: "How does Owners Inventory handle age-restricted products?",
        answer: "Tobacco, alcohol, and similar products are stored in their own category. Every sale is automatically recorded, giving you a ready compliance report for any audit."
    },
    {
        id: "4",
        question: "How much does your POS system cost?",
        answer: "The system is free to start, with a 3-month trial so you can run it across real shifts before committing. After the trial, pricing is based on your store size and the features you need. Contact us, and we'll send you a quote the same day."
    },
    {
        id: "5",
        question: "What if a barcode is damaged or missing at checkout?",
        answer: "Cashiers can search for any product by name or category directly on the checkout screen, keeping the checkout process moving without any delays."
    },
    {
        id: "6",
        question: "How quickly can new staff learn the system?",
        answer: "Most cashiers are comfortable at the checkout terminal within one shift. Role-based access control means new staff only see what is relevant to their role from day one, which keeps onboarding fast."
    },
];
...
export const CONVENIENCE_STORE_KEY_FEATURES = [
    {
        ...
        description: "Speed up your sales with integrated billing and custom item creation for a smoother customer experience.",
    ...
    },
    {
        ...
        description: "Know exactly what’s in stock. Every item sold is instantly deducted from your inventory for both store shelves and backrooms.",
    ...
    },
    {
        ...
        description: "Keep track of all your food manufacturers, manage purchase orders, and monitor your shipment statuses effortlessly.",
    ...
    },
    {
        ...
        description: "Manage different product styles, flavors, and categories in one easy-to-navigate catalog system.",
    ...
    },
    {
        ...
        description: "Build relationships with your mart customers using integrated CRM tools to track their preferences and order history.",
    ...
    },
    {
        ...
        description: "Sync your physical store with your online mart to manage all inventory and orders in one place.",
...
export const CONVENIENCE_STORE_TESTIMONIAL_DATA = {
    ...
    secondDescription: "Real-time inventory tracking, shift-level cash accountability, and fast barcode scanning checkout in one system built for high-volume retail. Start now and put the whole operation in one place.",
    whyChooseTitle: "Why Choose Owners Inventory for Convenience Stores?",
    whyChooseDescription: "Convenience stores run on thin margins and tight schedules. Here is why store owners trust Owners Inventory to keep their operations tight, their staff accountable, and their shelves stocked.",
};
...
export const CONVENIENCE_STORE_TESTIMONIAL_FEATURES = [
    {
        ...
        description: "Hundreds of transactions go through a busy c-store every single day. Our system handles that volume without slowing down, freezing, or losing records.",
        icon: "testWhychoseIcon1",
    },
    {
        id: "2",
        title: "Faster Checkout Every Time",
        description: "Barcode scanning finds the price before the customer has put their wallet away.",
        icon: "testWhychoseIcon2",
    },
    {
        id: "3",
        title: "Auto-Tracked Inventory",
        description: "Every sale updates your stock count on its own. When something runs low, you get an alert before it runs out on the shelf. No manual counting needed between shifts.",
        icon: "testWhychoseIcon3",
    },
    {
        id: "4",
        title: "Shift-Level Accountability",
        description: "Nothing floats between handovers with no name attached to it. Cash movements, voids, and transactions are all tied to a specific staff member and time, so if something is unusual, you know exactly who was at the counter.",
        icon: "testWhychoseIcon4",
    },
    {
        id: "5",
        title: "Quick Staff Onboarding",
        description: "New cashiers are confident at the checkout terminal within a single shift. The interface is built for speed, not complexity, which keeps training time short even with high staff turnover.",
        icon: "testWhychoseIcon5",
    },
    {
        id: "6",
        title: "Remote Store Access",
        description: "Your sales numbers, stock levels, and shift summaries are on your phone whenever you need them. You do not have to be in the store to know what is going on or to catch a problem before it gets worse. ",
        icon: "testWhychoseIcon6",
    },
    {
        id: "7",
        title: "Budget-Friendly Plans",
        description: "Professional-grade features without enterprise-level pricing. Plans are structured around the real costs of running an independent convenience store.",
        icon: "testWhychoseIcon7",
    },
    {
        id: "8",
        title: "Reliable Support",
        description: "Our team is available whenever you need help, from initial setup and data migration to a question that comes up mid-shift.",
...
export const CONVENIENCE_STORE_TOOLS_DATA = {
    ...
    paragraph: "Owners Inventory connects with the accounting and payment tools your business already uses, so sales data, financial records, and inventory levels stay consistent without manual data entry between systems.",
    tools: [

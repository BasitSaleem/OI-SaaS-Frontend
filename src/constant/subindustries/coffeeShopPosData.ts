...
export const COFFEE_SHOP_UNIFIED_HEADING = "Challenges Faced by Coffee Shops Today";

export const COFFEE_SHOP_UNIFIED_PARAGRAPH ="Modern coffee shops and cafes struggle to handle workflows, different order specifications, and payment delays. This makes daily processes harder. Without a proper POS, it becomes difficult to satisfy customers.";
...
export const COFFEE_SHOP_KEY_FEATURES_CARDS = [
   {
        ...
        imageSrc: "/assets/industries-pages/coffee-shop-pos/key-features-section/key-feature-card1.webp",
    },
    {
        id: 2,
        ...
        imageSrc: "/assets/industries-pages/coffee-shop-pos/key-features-section/key-feature-card2.webp",
    },
    {
        id: 3,
        ...
        imageSrc: "/assets/industries-pages/coffee-shop-pos/key-features-section/key-feature-card3.webp",
    },
    {
        id: 4,
        ...
        imageSrc: "/assets/industries-pages/coffee-shop-pos/key-features-section/key-feature-card4.webp",
    },
    {
        id: 5,
        ...
        imageSrc: "/assets/industries-pages/coffee-shop-pos/key-features-section/key-feature-card5.webp",
    },
];

export const COFFEE_SHOP_WORKFLOW_DATA = {
    heading: "Workflow of Owners Inventory POS for Coffee Shops",
    paragraph: "Owners Inventory POS manages daily operations by following step-by-step procedures. It supports fast-moving counter activities in cafes and coffee shops while keeping every order and transaction organized and trackable in real time.",
    steps: [
        {
            number: 1,
            title: "Ordering from the Counter",
            description: "The customers place orders at the counter in the coffee shops with the help of the POS system. The software helps the staff to capture orders efficiently and quickly with a few clicks. They can create the desired product along with the customization required. This makes order capturing precise while ensuring that the procedure starts easily."
        },
        {
            number: 2,
            title: "Automatic Order Routing",
            description: "After the order is confirmed, it is automatically sent to the correct preparation station. Whether it's coffee brewing or other item preparation, POS ensures each task is assigned precisely to the right person. This removes confusion between staff and improves efficiency."
        },
        {
            number: 3,
            title: "Preparation Tracking",
            description: "The kitchen staff get access to monitor orders placed from the dashboard in real-time. This enables them to keep track of order preparation status and work efficiently. It also improves coordination between counter staff and the preparation team, ensuring smoother processes.",
        },
        {
            number: 4,
            title: "Payment Processing",
            description: "The customer completes payments using different methods. The program instantly records the essential transaction data, such as the total cost, date, or time, and updates sales data, which helps maintain accurate sales records and reduces data inconsistencies.",
        },
        {
            number: 5,
            title: "Inventory Data Sync",
            description: "Once the order is completed, the tool updates the inventory levels automatically, such as used coffee beans, milk, or bakery items. It helps shop owners view stock levels with enhanced visibility and make better decisions for restocking."
        },
...
export const COFFEE_SHOP_FAQS = [
    {
        ...
        answer: "Our POS for coffee shops handles fast data entry, custom order details, and quick checkout procedures at the counter. It provides consistent performance during the morning rush hours and keeps the daily tasks of cafes streamlined."
    },
    {
        id: "2",
        question: "How does the Owners Inventory manage custom coffee orders?",
        answer: "It captures every order detail precisely, such as coffee type, milk, size, sugar quantity, and other demands. This helps staff deliver the exact order the customer has asked for, which increases satisfaction."
    },
    {
        id: "3",
        question: "How does it handle inventory for coffee shops?",
        answer: "Owners Inventory effectively manages the inventory operation by providing real-time visibility into stock levels, storing items according to category, and automating stock deduction after each order completion."
    },
    {
        id: "4",
        question: "How will your POS help my coffee shop grow?",
        answer: "Improving process flow, reducing errors, and managing customer data, it helps coffee shops increase efficiency, revenue, and overall growth. The system supports a long-term goal of coffee shops by providing advanced features to handle large volumes of data."
    },
    {
        id: "5",
        question: "Is it easy for staff to learn and use the system?",
        answer: "Yes, our coffee shop POS is well-designed and easy to use. The POS is simple to use, which is why staff do not require any specific technical training to use Owners Inventory."
    },
];
...
export const COFFEE_SHOP_KEY_FEATURES = [
    ...
    },
    {
        ...
        description: "Keep track of all your coffee shop manufacturers, manage purchase orders, and monitor your shipment statuses effortlessly.",
    ...
    },
    {
        ...
        description: "Build relationships with your coffee shop customers using integrated CRM tools to track their preferences and order history.",
    ...
    },
    {
        ...
        description: "Sync your physical store with your online coffee shop to manage all inventory and orders in one place.",
...
export const COFFEE_SHOP_TESTIMONIAL_DATA = {
    ...
    secondDescription: "Begin your journey with Owners Inventory and explore how a powerful POS can simplify coffee shop operations and orders from day one.",
    whyChooseTitle: "Why Choose Owners Inventory for Your Coffee Shop?",
    whyChooseDescription: "Owners Inventory POS fits naturally into how coffee shops operate in daily routines. It is fast at the counter, detailed and focused on order details, and consistent across operations.",
};
...
export const COFFEE_SHOP_TESTIMONIAL_FEATURES = [
    {
        ...
        description: "It follows how coffee orders actually move in a shop, keeping the procedures structured to reduce unnecessary steps for staff.",
        icon: "testWhychoseIcon1",
    },
    {
        id: "2",
        title: "Less Manual Work",
        description: "Automatic updates in inventory, orders, and payments reduce the need for manual tracking of everything and save time while increasing precision in tasks.",
        icon: "testWhychoseIcon2",
    },
    {
        id: "3",
        title: "Complex Order Handling",
        description: "It handles complex order variations such as size, milk type, and add-ons without confusion, keeping the counter ready with accurate orders.",
        icon: "testWhychoseIcon3",
    },
    {
        id: "4",
        title: "Structured Order Flow",
        description: "Each order follows a defined workflow from counter to preparation and payment. This reduces dependence on verbal coordination between staff.",
        icon: "testWhychoseIcon4",
    },
    {
        id: "5",
        title: "Peak Hour Stability",
        description: "The platform provides consistent performance even when the counters are busy at peak hours. It speeds up processes and saves customers from waiting for their order fulfillment.",
        icon: "testWhychoseIcon5",
    },
    {
        id: "6",
        title: "Growth-Ready System",
        description: "As your coffee shop grows, the software adapts to its needs while providing advanced features required to handle complex inventory and large-volume data.",

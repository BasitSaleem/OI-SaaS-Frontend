...
export const RESTAURANT_INVENTORY_UNIFIED_HEADING =
  "Challenges Faced by Restaurants Today";

export const RESTAURANT_INVENTORY_UNIFIED_PARAGRAPH =
  "Restaurants deal with issues like complex inventory, multiple ingredients for recipes, different food costs, and manual procedures. Handling all of them without inventory management software increases the risk of food waste, low revenue, and an unorganized kitchen.";
...
export const RESTAURANT_INVENTORY_FEATURE_CARDS: FeatureCardData[] = [
  {
    ...
    list: [
      {
        listheading: "POS Order Counter",
        listdescription:
          "Orders are linked directly to inventory usage. The system keeps a record of ingredient usage based on predefined recipes.",
        listSubDescription:
      ...
      {
        listheading: "Online Order and Delivery Sync ",
        listdescription:
          "Owners Inventory keeps your restaurant inventory aligned with every online and in-restaurant order. It reduces the required manual effort. As orders are processed, stocks get updates automatically to identify actual ingredient usage.",
        listSubDescription:
          "This maintains accurate and up-to-date inventory information across all sales and ordering channels.",
      },
      {
        listheading: "Centralized Order Dashboard",
        listdescription:
          "It provides a centralized dashboard to track all restaurant activities. It allows store owners to monitor order flow, track restaurant performance, and manage purchase operations efficiently. This eliminates confusion caused by multiple systems.",
        listSubDescription:
          "It also maintains a smooth workflow between kitchen storage, sales, and inventory management.",
      },
    ],
  },
  {
  ...
  steps: [
    {
      ...
      description:
        "It creates purchase orders based on stock levels and demand. It tracks and keeps an accurate record of incoming inventory. The system ensures the timely delivery of essential kitchen items, supporting smooth operations.",
    },
    {
      number: 2,
      title: "Stock Organization",
      description:
        "Every item in inventory is categorized by its name, storage areas, and kitchen sections, which helps staff find items quickly. This ensures real-time visibility across all stock locations. With a structured organization, our restaurant management software makes all operations smooth.",
    },
    {
      number: 3,
    ...
    },
    {
      ...
      description:
        "The system generates reports on inventory usage, food costs, and variances, which help restaurants identify inefficiencies in different areas. The reports provide restaurant owners with accurate insights that support better decision-making. It also reduces waste and eliminates inefficiencies.",
    },
  ],
};
...
export const RESTAURANT_INVENTORY_FAQS = [
  ...
  },
  {
    ...
    answer:
      "Yes, the system compares actual usage with theoretical usage based on recipes. This helps identify variances, control food cost, and reduce losses caused by overuse, waste, or untracked consumption.",
  },
  {
    id: "3",
    question: "How does the system manage inventory across multiple locations?",
    answer:
      "With centralized control access, Owners Inventory provides visibility into stocks across multiple locations. It monitors inventory, tracks transfers, and provides consistent real-time updates from a single dashboard.",
  },
  {
    id: "4",
    question: "How does Owners Inventory reduce dependency on manual counting?",
    answer:
      "Inventory is automatically updated through usage tracking. These features reduce the need for manual counting. It also improves accuracy across different restaurant operations.",
  },
  {
    id: "5",
    question:
...
export const RESTAURANT_INVENTORY_TESTIMONIAL_DATA = {
  ...
  secondDescription:
    "Every untracked ingredient and missed expiry date costs your restaurant real money. Owners Inventory gives you the visibility and control to stop the losses.",
  whyChooseTitle: "Why Choose Restaurant Inventory Management Software",
  whyChooseDescription:
    "Owners Inventory can efficiently handle all complex restaurant tasks. It offers accurate ingredient usage, inventory management, and food cost control. The system makes it easy to make better purchase decisions and boost overall operational efficiency.",
};
...
export const RESTAURANT_INVENTORY_TESTIMONIAL_FEATURES = [
  ...
  },
  {
    ...
    description:
      "Owners Inventory reduces the reliance on frequent manual inventory checks by providing real-time inventory visibility across the kitchen and storage.",
  ...
  },
  {
    ...
    description:
      "It tracks ingredients' expiry dates and stock movement, which helps reduce waste and prevent item spoilage. It ensures better utilization of resources across daily restaurant operations.",
  ...
  },
  {
    ...
    description:
      "Inventory processes such as stock counting, deliveries, and updates are simplified with easy-to-understand information and a unified dashboard, which helps manage multiple restaurant operations within one system.",
  ...
  },
  {
    ...
    description:
      "The system adjusts with increasing work, helping restaurants manage higher sales volume, larger inventories, and additional locations. It expands your business without losing control.",

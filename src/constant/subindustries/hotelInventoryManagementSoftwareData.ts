...
export const HOTEL_INVENTORY_UNIFIED_HEADING = "Challenges Holding Back Hotel Businesses";

export const HOTEL_INVENTORY_UNIFIED_PARAGRAPH = "Inventory management software is critical to the success of hotels as it directly affects guest satisfaction. Many hospitality businesses face significant challenges such as:";
...
export const HOTEL_INVENTORY_FEATURE_CARDS: FeatureCardData[] = [
    {
        ...
        imageSrc: "/assets/industries-pages/hotel-inventory-management-software/omini-chanel.webp",
        buttonLabel: "View Details",
        buttonHref: "/features/inventory-management",
        buttonColor: "var(--primary-purple)",
        listVariant: "accordion",
        list: [
            { listheading: "Centralized Hotel Operations Management", listdescription: "To eliminate confusion and increase efficiency, manage all activities related to inventory from a single dashboard. A single source of information allows for better stock control and simplifies day-to-day operations." },
            { listheading: "Housekeeping Supply Optimization", listdescription: "Assure that the housekeeping department has all of the necessary supplies, without any overstocking. Tracking helps to maintain standards of service and enhances the readiness of rooms." },
            { listheading: "Maintenance of Inventory Tracking", listdescription: "Maintain a list of all the tools, parts, and materials needed for maintenance. It is important to ensure that the maintenance work does not get delayed because of missing stock." },
            { listheading: "Real-time Operational Visibility", listdescription: "Take faster, more accurate, and timely decisions by gaining access to real-time information on the inventory levels in all departments and areas of storage. It improves operational planning and responsiveness." },
        ]
    },
    {
        id: "2",
        title: "Better Decision Reporting & Analytics",
        description: "Our deep insight into hotel inventory management software operations will help you to make more informed and profitable decisions.",
        imageSrc: "/assets/industries-pages/hotel-inventory-management-software/better-decision.webp",
        buttonLabel: "View Details",
...
export const HOTEL_INVENTORY_KEY_FEATURES_CARDS = [
    {
        ...
        description: "The inventory levels are updated automatically whenever an item is consumed, transferred, or restocked. This ensures complete accuracy, eliminates manual updating delays, and minimizes stock mismatches. Managers can instantly monitor stock level, allowing them to make more informed and faster decisions. The real-time tracking improves the coordination of departments, as everyone works with updated data.",
        imageSrc: "/assets/industries-pages/hotel-inventory-management-software/key-features-section/key-features-card1.webp",
    },
    {
        id: 2,
        title: "Housekeeping  Inventory Management",
        description: "It ensures uninterrupted service by tracking linens, towels, toiletries, and cleaning products, as well as room essentials. It helps the housekeeping team maintain optimal stock levels and avoid shortages at peak times. The system allows for tracking usage patterns by room or floor to improve planning and efficiency.",
        imageSrc: "/assets/industries-pages/hotel-inventory-management-software/key-features-section/key-features-card2.webp",
    },
    {
        id: 3,
        title: "Multi-Department Inventory System",
        description: "The unified system allows you to manage inventory in all departments including housekeeping, maintenance, and laundry. It eliminates the need to use separate tracking tools, and improves coordination among teams. The management can maintain full visibility and control over the whole operation while each department has access to relevant data.",
        imageSrc: "/assets/industries-pages/hotel-inventory-management-software/key-features-section/key-features-card3.webp",
    },
    {
        id: 4,
        ...
        imageSrc: "/assets/industries-pages/hotel-inventory-management-software/key-features-section/key-features-card4.webp",
    },
    {
        id: 5,
        ...
        imageSrc: "/assets/industries-pages/hotel-inventory-management-software/key-features-section/key-features-card5.webp",
    },
    {
        id: 6,
        title: "Purchase Order & Supplier Tracking",
        description: "Maintain consistent stock availability, manage suppliers, monitor timelines for delivery, track purchase orders, and keep track of purchase orders. This system records all vendor interactions to help you assess supplier performance and improve your procurement decisions. It ensures a reliable supply chain and avoids shortages at the last minute.",
        imageSrc: "/assets/industries-pages/hotel-inventory-management-software/key-features-section/key-features-card6.webp",
    },
    {
        id: 7,
        title: "Consumption & Usage Reports",
        description: "Create detailed reports in order to identify items with high consumption or costs. This information helps you reduce waste, improve stock levels, and optimize purchasing strategies. This leads to improved cost control and better inventory planning over time.",
        imageSrc: "/assets/industries-pages/hotel-inventory-management-software/key-features-section/key-features-card7.webp",
    },
    {
        id: 8,
        title: "Automatic Alerts and Notifications",
        description: "You will receive real-time notifications when stock levels are low, delayed replenishment, or abnormal consumption patterns. You can take action immediately before problems affect your operations. Automatic alerts help ensure critical products are available at all times and avoid service interruptions.",
        imageSrc: "/assets/industries-pages/hotel-inventory-management-software/key-features-section/key-features-card8.webp",
    },
    {
        id: 9,
        ...
        imageSrc: "/assets/industries-pages/hotel-inventory-management-software/key-features-section/key-features-card9.webp",
    },
    {
        id: 10,
        ...
        imageSrc: "/assets/industries-pages/hotel-inventory-management-software/key-features-section/key-features-card10.webp",
    },
];

export const HOTEL_INVENTORY_WORKFLOW_DATA = {
    heading: "Inventory Workflow Process for Owners Inventory",
    paragraph: "Our hotel inventory management software follows a structured and efficient workflow designed to simplify daily operations and maintain accurate stock control across all departments.",
    steps: [
        {
            number: 1,
            title: "Planning for Inventory Procurement",
            description: "Stock is planned based on seasonality, occupancy, and operational requirements. It is important to ensure that inventory levels are in line with the actual needs of your business. This will reduce both overstocking and understocking. Planning properly also maintains a balance of cost and availability."
        },
        {
            number: 2,
            title: "Structured Storage & Categorization",
            description: "The inventory is organized by type and frequency of use, which makes it easy to find and manage the items. An organized storage system makes it easier to find items and saves time."
        },
        {
            number: 3,
            title: "Live Monitoring and Updates",
            description: "The stock levels are updated continuously as the items are transferred or used, which ensures accurate tracking. The real-time transparency allows managers to react quickly to changes in inventory and ensure operational continuity."
        },
        {
            number: 4,
            title: "Supplier Coordination & Reordering",
            description: "It avoids interruptions, manages vendor relationships, tracks delivery, and makes sure to restock on time. It helps to maintain a constant supply chain, and it improves communication with suppliers."
        },
        {
            number: 5,
            title: "Internal Distribution & Usage Tracking",
            description: "The inventory is divided among departments and tracked, which ensures accountability. It is possible to identify departments that consume the most resources, and areas where improvements are needed."
        },
        {
            number: 6,
            title: "Reporting, Insights & Optimization",
            description: "Analysis of inventory data can improve buying decisions, decrease waste, and optimize operations. Businesses can adapt to changes in demand and efficiency by using continuous monitoring and reporting."
        },
    ]
};
...
export const HOTEL_INVENTORY_FAQS = [
    {
        ...
        answer: "Hotel inventory management software is a system that helps track and manage inventory in real-time, including housekeeping materials, maintenance supplies, and operational stocks. It provides full visibility and reduces errors. All departments can access accurate data to make better decisions."
    },
    {
        id: "2",
        question: "Can it manage different departments within a hotel or resort?",
        answer: "It supports several departments, including laundry, housekeeping, maintenance and storage so that the management can maintain full control over the hotel and have visibility into all departments. Each department has its own tracking system."
    },
    {
        id: "3",
        question: "Can it reduce manual labor?",
        answer: "It automates stock tracking, alerts, reports, and reporting which reduces the need for manual spreadsheets and logs. This saves time, and minimizes human error in day-to-day operations."
    },
    {
        id: "4",
        question: "Does it reduce the cost of inventory?",
        answer: "The system can help you make better purchasing decisions. It provides accurate data on usage and waste which ensures the correct stock levels are maintained, and reduces unnecessary expenditures caused by emergency purchases or overstocking."
    },
    {
        id: "5",
        question: "Does it work for hotels having large chains?",
        answer: "It is designed for multi-location operation and fully scalable. A centralized inventory system allows large hotel chains to manage multiple properties while still maintaining control in each property."
    },
];
...
export const HOTEL_INVENTORY_KEY_FEATURES = [
    {
        ...
        description: "Speed up your procurement with integrated order processing and automatic stock updates for a smoother hospitality experience.",
    ...
    },
    {
        ...
        description: "Keep track of all your hotel suppliers, manage purchase orders, and monitor your shipment statuses effortlessly.",
        imageSrc: "/assets/features-page/featurescard-banners/purchases-banner.webp",
    },
    {
        id: "hotel-variants",
        title: "Item & Supply Tracking",
        description: "Manage different hotel items, sizes, and categories in one easy-to-navigate catalog across all departments.",
        imageSrc: "/assets/features-page/featurescard-banners/inventory-banner.webp",
    },
    {
        id: "hotel-loyalty",
        title: "Guest & Record Management",
        description: "Build better guest care using integrated CRM tools to track history and supply needs.",
...
export const HOTEL_INVENTORY_TESTIMONIAL_FEATURES = [
    {
        id: "1",
        title: "Easy Setup",
        description: "Implementation is quick and minimally disruptive to your daily operations which allows you to quickly start using the software. The setup is simple and easy to follow, so that your team can quickly adapt without needing complex technical skills or lengthy training sessions. It ensures faster implementation and operational improvement.",
        icon: "testWhychoseIcon1",
    },
    {
        id: "2",
        title: "Reliable Performance",
        description: "Even during high demand periods and peak season, the system is able to handle multi-department inventory and large volumes of stock efficiently. It is designed to work consistently even under high pressure. This ensures that inventory operations are accurate and stable, regardless of the workload.",
        icon: "testWhychoseIcon2",
    },
    {
        id: "3",
        title: "Real-time Visibility",
        description: "Know what is in stock, where it's located, and when to replenish it. The real-time view eliminates the guesswork, and enables managers to take quick and informed decisions. This reduces delays and prevents stock-related disruptions.",
        icon: "testWhychoseIcon3",
    },
    {
        id: "4",
        title: "Advanced Reporting",
        description: "With detailed analytics, usage reporting, and performance insights, you can make better decisions. Our reporting tools help you understand inventory trends and identify waste, reduce costs, and improve planning.",
        icon: "testWhychoseIcon4",
    },
    {
        id: "5",
        title: "Scalable Software",
        description: "The system is suitable for both small and large hotels. It can adapt to the growth of your business and can scale with you, whether it is a single location or multiple properties. It will not compromise performance or control.",
        icon: "testWhychoseIcon5",
    },
    {
        id: "6",
        title: "Secure Access Control",
        description: "Ensure data security by granting permissions based on roles and limiting access to different employees. It protects sensitive data while giving teams access to only what they need.",

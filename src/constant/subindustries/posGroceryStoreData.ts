...
export const GROCERY_STORE_UNIFIED_HEADING =
  "Challenges Holding Back Grocery Stores";
...
export const GROCERY_STORE_WORKFLOW_DATA = {
  ...
  paragraph:
    "Our POS software is designed for grocery stores that facilitates seamless inventory between purchase and sale.",
  steps: [
    {
      number: 1,
      title: "Inventory Procurement",
      description:
        "Order goods with reputable suppliers according to the forecasts of the demand. Check received goods and then add them into the system.",
    },
    {
      number: 2,
      title: "Organized Storage",
      description:
        "Classify products according to type, brand or expiry date. Labeling enhances better shelf management and eliminates confusion.",
    },
    {
      number: 3,
      title: "Real-Time Tracking",
      description:
        "Any stock movement, sale, returns, or transfers is automatically updated in order to monitor them accurately.",
    },
    {
      number: 4,
      title: "Supplier Coordination",
      description:
        "Track lead times, prices, and supplier performance to ensure timely replenishment.",
    },
    {
      number: 5,
      title: "Order Processing",
      description:
        "Orders made online and in-store update stock immediately, and orders are fulfilled correctly.",
    },
    {
      number: 6,
      title: "Reporting & Analysis",
      description:
        "Detailed reports are used in the analysis of fast selling goods, level of wastage and profit margins.",
    },
  ],
};
...
export const GROCERY_STORE_FAQS = [
  {
    ...
    answer:
      "Grocery POS in Owners Inventory is a complete system designed to help grocery businesses manage billing, inventory, and products all in one place. Whether you run a small neighborhood shop or a large supermarket chain, it helps you track stock, manage prices, and handle checkout smoothly.",
  },
  {
    id: "2",
  ...
  },
  {
    ...
    answer:
      "Absolutely. You can easily create and manage deals, combo offers, price drops, and percentage discounts whenever you want. The system applies them correctly during billing, making it simple to run promotions and attract more customers.",
  },
  {
    id: "4",
    question: "Does it fit my store size?",
    answer:
      "Yes. Owners Inventory is built to work for all types of stores, from small grocery setups to multi-branch supermarkets. You can start with basic features and expand as your business grows.",
  },
  {
    id: "5",
    question: "Can I import my existing product list?",
    answer:
      "Yes. You can bring all your current products into the system easily using Excel or CSV files. Thousands of items can be uploaded within minutes, so you don’t have to enter each product manually.",
  },
];
...
export const GROCERY_STORE_TESTIMONIAL_DATA = {
  ...
  secondDescription:
    "Get full control of your inventory, billing, and daily operations using a POS system designed to suit the needs of the modern grocery retailers.",
  whyChooseTitle: "Why Choose Our System?",
  whyChooseDescription:
    "The grocery store POS system will allow you to bill fast, track inventory and conduct your day-to-day operations effectively and in a profitable manner.",
};
...
export const GROCERY_STORE_TESTIMONIAL_FEATURES = [
  {
    ...
    title: "Easy Setup",
    description:
      "The interface is simple and easy to use. The installation is fast and the disruption to your day-to-day activities in the store is minimal.",
  ...
  },
  {
    ...
    description:
      "It runs smoothly and it does not malfunction during peak hours and high customer traffic making the checkout counters fast and stable.",
  ...
  },
  {
    ...
    description:
      "All perishable items are arranged and non-perishable goods according to category, batch and expiry date, and clean and correct inventory control.",
  ...
  },
  {
    ...
    description:
      "Get easy and straightforward reports on sales, stock value, profits and hot selling items. These insights will make you make better business decisions.",
  ...
  },
  {
    ...
    description:
      "The product is targeted at supermarkets, mini marts, and small grocery stores of any size across the neighborhood. The system is modifiable to your business needs.",
  ...
  },
  {
    ...
    title: "Safe Access",
    description:
      "Role-based permissions safeguard financial and inventory information. Having secure access is given to cashiers, managers and admins based on their responsibility.",

...
export const CLOTHING_INVENTORY_KEY_FEATURES_CARDS = [
   
   {
        ...
        imageSrc: "/assets/industries-pages/clothing-inventory-management-software/key-features-section/key-features-card1.webp",
    },
    {
        id: 2,
        ...
        imageSrc: "/assets/industries-pages/clothing-inventory-management-software/key-features-section/key-features-card2.webp",
    },
    {
        id: 3,
        ...
        imageSrc: "/assets/industries-pages/clothing-inventory-management-software/key-features-section/key-features-card3.webp",
    },
    
    {
        ...
        imageSrc: "/assets/industries-pages/clothing-inventory-management-software/key-features-section/key-features-card4.webp",
    },
    {
        id: 5,
        ...
        imageSrc: "/assets/industries-pages/clothing-inventory-management-software/key-features-section/key-features-card5.webp",
    },
    {
        id: 6,
        ...
        imageSrc: "/assets/industries-pages/clothing-inventory-management-software/key-features-section/key-features-card6.webp",
    },
    {
        id: 7,
        ...
        imageSrc: "/assets/industries-pages/clothing-inventory-management-software/key-features-section/key-features-card7.webp",
    },
    {
        id: 8,
        ...
        imageSrc: "/assets/industries-pages/clothing-inventory-management-software/key-features-section/key-features-card8.webp",
    },
      {
        id: 9,
        ...
        imageSrc: "/assets/industries-pages/clothing-inventory-management-software/key-features-section/key-features-card9.webp",
    },
     {
        id: 10,
        ...
        imageSrc: "/assets/industries-pages/clothing-inventory-management-software/key-features-section/key-features-card10.webp",
    },
...
export const CLOTHING_INVENTORY_WORKFLOW_DATA = {
    ...
    paragraph: "Our clothing inventory management software automatically updates stock levels. This makes inventory control simple and efficient for fashion retailers.",
    steps: [
        {
            number: 1,
            title: "Inventory Acquisition",
            description: "Store owners find clothing items from suppliers they trust based on demand and trends. They also think about collections. Every product is checked for quality, correct sizes, and accurate quantities."
        },
        {
            number: 2,
            title: "Stock Organization & Storage",
            description: "The system organizes clothing items by type, size, color or brand. We label everything clearly. Items are arranged in a way that makes sense. This makes it easy for our staff to find products quickly. It cuts down on confusion. This saves time during busy hours."
        },
        {
            number: 3,
        ...
        },
        {
            ...
            description: "Our system is really helpful when we work with clothing suppliers. Store owners can make orders, track when products are being delivered and check on how our suppliers are doing. This helps store owners get items in stock on time."
        },
        {
            number: 5,
...
export const CLOTHING_INVENTORY_FAQS = [
    {
        ...
        answer: "It is a tool that helps manage the stock, sales and customers all in one place. It helps keep track of the clothing items, including the sizes and types. It also makes billing process easy."
    },
    {
        id: "2",
    ...
    },
    {
        ...
        answer: "Yes, the clothing inventory management software is easy to use. The staff can do billing, manage inventory and look at reports without needing to be trained."
    },
    {
        id: "4",
        question: "Does it provide reports and insights?",
        answer: "Yes, the clothing inventory management software provides reports on sales, stock and profits in real-time. This helps store owners make decisions."
    },
    {
        id: "5",
        question: "Can multiple users access the system securely?",
        answer: "Yes, the clothing inventory management software has role-based permissions. This means that different staff members can use the software while keeping information safe."
    },
];
...
export const CLOTHING_INVENTORY_KEY_FEATURES = [
    ...
    },
    {
        ...
        description: "Manage different clothing styles, materials, and variants in one easy-to-navigate catalog software.",
...
export const CLOTHING_INVENTORY_TESTIMONIAL_DATA = {
    ...
    whyChooseDescription: "Our clothing inventory management software ensures stock control, fast billing, and smooth daily operations.",
};
...
export const CLOTHING_INVENTORY_TESTIMONIAL_FEATURES = [
    ...
    },
    {
        ...
        description: "The system is designed to support clothing stores of all sizes. It works for boutiques and large retail chains.",

...
export const SMALL_BUSINESS_INVENTORY_UNIFIED_HEADING = "Challenges Small Businesses Face in Inventory Management";

export const SMALL_BUSINESS_INVENTORY_UNIFIED_PARAGRAPH = "Managing inventory in a small business becomes difficult when systems are not connected. Without a reliable inventory management system, the day-to-day operations slow down, and the chances of errors increase.";
...
export const SMALL_BUSINESS_INVENTORY_FEATURE_CARDS: FeatureCardData[] = [
    {
        ...
        imageSrc: "/assets/industries-pages/small-businesses-inventory-management-software/omini-chanel.webp",
    ...
    },
    {
        ...
        imageSrc: "/assets/industries-pages/small-businesses-inventory-management-software/better-decision.webp",
        buttonLabel: "View Details",
...
export const SMALL_BUSINESS_INVENTORY_KEY_FEATURES_CARDS = [
    {
        ...
        imageSrc: "/assets/industries-pages/small-businesses-inventory-management-software/key-features-section/key-features-card1.webp",
    },
    {
        id: 2,
        ...
        imageSrc: "/assets/industries-pages/small-businesses-inventory-management-software/key-features-section/key-features-card2.webp",
    },
    {
        id: 3,
        title: "Warehouse Control",
        description: "The software allows small business owners to manage inventory across multiple locations, including warehouses and in-store items. It ensures stocks stay easily accessible and organized.",
        imageSrc: "/assets/industries-pages/small-businesses-inventory-management-software/key-features-section/key-features-card3.webp",
    },
    {
        id: 4,
        ...
        imageSrc: "/assets/industries-pages/small-businesses-inventory-management-software/key-features-section/key-features-card4.webp",
    },
    {
        id: 5,
        ...
        imageSrc: "/assets/industries-pages/small-businesses-inventory-management-software/key-features-section/key-features-card5.webp",
    },
...
export const SMALL_BUSINESS_INVENTORY_WORKFLOW_DATA = {
    ...
    paragraph: "Owners Inventory follows the natural flow of how small businesses buy, manage, and sell products. It connects every workflow step with others to ensure operational accuracy. This gives business owners full visibility of management procedures.",
    steps: [
        {
            number: 1,
        ...
        },
        {
            ...
            description: "Incoming orders are processed efficiently while inventory is being checked for availability, which helps small businesses fulfill orders on time and maintain proper coordination between stock levels and customer demands."
        },
        {
            number: 5,
...
export const SMALL_BUSINESS_INVENTORY_TESTIMONIAL_DATA = {
    ...
    whyChooseDescription: "Owners Inventory is built for small business owners who need accurate inventory control without complicated system setups and large IT teams. Our software is reliable, efficient, and designed to support real business operations.",
};
...
export const SMALL_BUSINESS_INVENTORY_TESTIMONIAL_FEATURES = [
    {
        ...
        description: "The system fulfills the daily inventory management needs of small businesses, such as stock tracking, sales recording, and growth tracking.",
        icon: "testWhychoseIcon1",
    },
    {
        id: "2",
        title: "Quick Setup",
        description: "Small businesses can add their product catalogs, connect sales channels, and start tracking inventory. It allows you to carry on with existing operations without disruption.",
    ...
    },
    {
        ...
        description: "The system provides operational support to small businesses, which helps them automate routine tasks and focus on main operations that effectively help them grow.",

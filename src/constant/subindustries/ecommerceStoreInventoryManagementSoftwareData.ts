...
export const ECOMMERCE_INVENTORY_UNIFIED_HEADING =
  "Challenges Holding Back Ecommerce Businesses";

export const ECOMMERCE_INVENTORY_UNIFIED_PARAGRAPH =
  "Every day, ecommerce companies face a number of challenges that may slow growth or increase costs. These challenges can include:";
...
export const ECOMMERCE_INVENTORY_FEATURE_CARDS: FeatureCardData[] = [
  {
    ...
    list: [
      {
        listheading: "Ecommerce Sales Management",
        listdescription:
          "Manage your inventory and orders all from the same place. It is easy to keep track of daily transactions and product performance. It helps you run your online business smoothly.",
      },
      {
        listheading: "Online Order Processing",
        listdescription:
          "Manage orders from beginning to end efficiently and accept secure payments. This system allows you to process orders faster, minimize delays and make sure that your customers receive their products on time. It builds customer trust and improves satisfaction.",
      },
      {
        listheading: "Unified Multi-Channel Control",
        listdescription:
          "You can view your business performance, including orders and inventory in real-time across multiple platforms. It's easier to keep track of stock, prevent errors and make better business decisions.",
        listSubDescription:
          "You can deliver an experience that is consistent and reliable to all your customers, no matter from where they are shopping. This ensures your ecommerce operation is organized, efficient, and fast.",
      },
    ],
  },
  {
...
export const ECOMMERCE_INVENTORY_WORKFLOW_DATA = {
  ...
  paragraph:
    "Our eCommerce inventory management software automates inventory tasks to simplify operations.",
  steps: [
    {
      number: 1,
      title: "Inventory Acquisition",
      description:
        "Demand is used to determine the addition of products from suppliers. The system records each product for tracking.",
    },
    {
      number: 2,
      title: "Stock Organization & Storage",
      description:
        "The inventory is structured in such a way that it's easy to manage and find. Keep products well-organized to reduce handling time and improve overall efficiency.",
    },
    {
      number: 3,
    ...
    },
    {
      ...
      description:
        "To avoid shortages, manage suppliers, track delivery, and replenish products at the right time. Ensure smooth coordination with vendors to maintain a steady and reliable supply chain.",
    },
    {
      number: 5,
      title: "Order Fulfillment",
      description:
        "All orders are accurately picked, packaged, and sent. It reduces errors and increases speed. Streamline your workflow to deliver orders faster and improve customer satisfaction.",
    },
    {
      number: 6,
      title: "Reporting & Analysis",
      description:
        "We provide you with detailed information on sales, inventory levels and revenue. Use actionable insights to identify trends and make smarter business decisions.",
    },
  ],
};
...
export const ECOMMERCE_INVENTORY_FAQS = [
  {
    ...
    answer:
      "The Ecommerce Inventory Management Software is an online system which helps manage orders and sales on different platforms. The software automatically tracks inventory, updates inventory levels and minimizes manual labor. It makes your online business run more efficiently.",
  },
  {
    id: "2",
    question: "Is it able to handle multiple channels of sales?",
    answer:
      "The system can manage your mobile app, website, and marketplaces. Inventory is synced across platforms in real-time, so that you don't have to worry about issues such as overselling and stock mismatches.",
  },
  {
    id: "3",
    question: "Does it make the job of staff easy?",
    answer:
      "The system is easy to use. Staff can learn to track orders, manage inventory, and make sales easily without needing any advanced technical knowledge. It saves time by reducing the training effort.",
  },
  {
    id: "4",
    question: "Is it able to provide insights and reports?",
    answer:
      "The system does provide real-time information on stock, sales and performance. This information helps you to understand what products sell well, how often to stock up, and improve business decisions.",
  },
  {
    id: "5",
    question: "Does the system allow multiple users to access it?",
    answer:
      "The system does include role-based security. You can give different permissions for staff like administrators, managers, and operators. This keeps data secure and only allows authorized users to access information.",
  },
];
...
export const ECOMMERCE_INVENTORY_TESTIMONIAL_DATA = {
  ...
  whyChooseDescription:
    "Our system gives you complete control of your online inventory and business operations. This system is built to help you simplify daily tasks and reduce mistakes, while also helping your business grow more quickly with greater visibility.",
};
...
export const ECOMMERCE_INVENTORY_TESTIMONIAL_FEATURES = [
  {
    ...
    title: "Simple Setup",
    description:
      "It is easy to install and does not affect your day-to-day operations. It is easy to get up and running without the need for technical knowledge or lengthy training.",
  ...
  },
  {
    ...
    description:
      "Our system is able to handle high order volumes, multiple platforms and sales channels with ease. It ensures your business runs smoothly, even during busy periods.",
  ...
  },
  {
    ...
    description:
      "It is always possible to see the stock levels and their locations. You can avoid unnecessary losses, confusion and stock mismatches by getting real-time updates.",
  ...
  },
  {
    ...
    description:
      "You can get detailed information about your inventory, sales, and profit. You can use these reports to better understand the performance of your business and make more informed decisions.",
  ...
  },
  {
    ...
    title: "Flexibility",
    description:
      "This system supports eCommerce companies of any size. It adapts to the needs of any business, whether it is a small shop or an established brand.",
  ...
  },
  {
    ...
    title: "Secure Access",
    description:
      "Only authorized users have access to certain features and data. Your business data is kept safe.",
  ...
  },
  {
    ...
    description:
      "Our system integrates seamlessly with shipping platforms, accounting software, payment gateways, and eCommerce platforms. The integrations improve productivity and reduce the amount of manual work.",

...
export const FURNITURE_STORE_UNIFIED_HEADING =
  "Challenges Holding Back Furniture Stores";
...
export const FURNITURE_STORE_FEATURE_CARDS = [
  {
    ...
    list: [
      ...
      { listheading: "Ecommerce and Online Orders" },
      { listheading: "Centralized Multi-Channel Control" },
    ],
  },
  {
    id: "2",
    ...
    buttonColor: "#1AD1B9",
    list: [
      { listheading: "Identify fast and slow moving products" },
      { listheading: "Forecast demand and plan smarter reorders" },
      {
        listheading:
...
export const FURNITURE_STORE_WORKFLOW_DATA = {
  ...
  steps: [
    ...
    },
    {
      ...
      description:
        "Categorize items by type, material, collection, or room category for easy tracking. Well-structured storage reduces confusion and improves showroom efficiency.",
    },
    {
      number: 3,
      title: "Real-Time Inventory Tracking",
      description:
        "All movements are updated in real time in the system. You never have to check stock levels manually to get up-to-date levels.",
    },
    {
      number: 4,
      title: "Order & Delivery Management",
      description:
        "Track customer orders between booking and final delivery and installation. Get rid of late deliveries and ensure that they are delivered in time and in orderly fashion.",
    },
    {
      number: 5,
      title: "Returns & Damage Control",
      description:
        "Returned, exchanged, and damaged items are entered into the system appropriately. Ensure that there are good stock adjustments to avoid stock variances and losses.",
    },
    {
      number: 6,
      title: "Reporting & Analysis",
      description:
        "Prepare stock value, pending delivery, profits, and seasonal demand trends reports to make sound decisions regarding buying and reducing inventory.",
    },
  ],
};
...
export const FURNITURE_STORE_FAQS = [
  {
    ...
    answer:
      "It is software that is utilized to process sales, inventory, deliveries, and custom orders. Big products, colors, sizes, and materials remain tracked correctly. Warehouses and showrooms are in real time contact.",
  },
  {
    id: "2",
    question: "Is it able to manage several branches?",
    answer:
      "Yes, the furniture store POS system ensures that all locations are in sync. Reports, inventory and stock transfers remain in order across branches. Managers are able to observe all this on a single dashboard.",
  },
  {
    id: "3",
    question: "Does it support mobile sales?",
    answer:
      "Yes, the furniture mobile POS software enables on-floor billing and quotations. Salespeople are able to monitor inventory and seal transactions in real time. Customers are offered prompt and precise invoices.",
  },
  {
    id: "4",
    question: "Can it manage custom orders?",
    answer:
      "Yes, the POS system of furniture captures bespoke sizes, finishes and materials. Detailed information is provided to production teams. Error and confusion are minimized.",
  },
  {
    id: "5",
    question: "Does it provide reports and analytics?",
    answer:
      "Yes, the furniture POS software generates sales, inventory, and performance reports. Products that are slow moving and those that are old can be traced easily. Owners can make better purchase decisions and stocking decisions.",
  },
];
...
export const FURNITURE_STORE_TESTIMONIAL_DATA = {
  ...
  secondDescription:
    "Gain complete control over your inventory, sales, custom orders, and deliveries with a system designed for modern furniture businesses.",
  whyChooseTitle: "Why Choose Our POS System?",
  whyChooseDescription:
    "Our furniture POS system helps to simplify, improve precision, and efficiency of furniture retailing.",
};
...
export const FURNITURE_STORE_TESTIMONIAL_FEATURES = [
  {
    ...
    description:
      "The system is easy to work with big items, various sizes, and special orders. Warehouses and showrooms remain in touch.",
  ...
  },
  {
    ...
    description:
      "Inventory, options and finishes are updated in real-time. Mistakes are minimized and managers can make decisions quicker.",
  ...
  },
  {
    ...
    description:
      "Sales teams are able to sell on the showroom floor. Every customer receives a quote and invoice immediately.",
  ...
  },
  {
    ...
    description:
      "All store locations remain aligned with centralized management. Reports, stock and transfers are kept in order among the branches.",
  ...
  },
  {
    ...
    description:
      "The records of customer history, warranties, and custom orders remain in history. Individualized service is made easy and dependable.",
  ...
  },
  {
    ...
    description:
      "The stock performance and sales trends remain visible at any time. Planning and effective purchases become easier.",
  ...
  },
  {
    ...
    description:
      "Combined with accounting, eCommerce, barcode scanners and payment gateways. Scalable furniture store solution is achieved by add-ons such as loyalty programs, SMS alerts, multi-branch, delivery tracking, and supplier tools.",
...
export const FURNITURE_STORE_TOOLS_DATA = {
  ...
  paragraph:
    "The POS solutions of modern furniture stores are combined with accounting software, CRM systems, payment gateways, and eCommerce platforms. This enables proprietors to control inventory, showroom sales, online orders, finances and customer data on a single centralized dashboard.",
  tools: [
    {
      id: 1,
      name: "Shopify",

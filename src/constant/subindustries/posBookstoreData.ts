...
export const BOOKSTORE_UNIFIED_HEADING =
  "Challenges That Bookstores Face Today";
...
export const BOOKSTORE_WORKFLOW_DATA = {
  ...
  paragraph:
    "Our POS software in the bookstore automates inventory operations to be accurate and efficient, with all the book movements being traced between purchase and sale.",
  steps: [
    {
      number: 1,
      title: "Inventory Acquisition",
      description:
        "Books are ordered by publishers and distributors based on the demand forecasts. Verify quantities and conditions and add them to the system. This ensures that you only have the right and saleable inventory in your inventory books.",
    },
    {
      number: 2,
      title: "Stock Organization & Storage",
      description:
        "Sort books into genres, authors, publishers or sections to identify them easily and handle them faster. Adequate organization saves time on search and enhances in-store shopping.",
    },
    {
      number: 3,
      title: "Inventory Tracking",
      description:
        "Sales, returns and transfers are automatically updated in real time and the availability is correct. This avoids stock mismatch and assists in avoiding lost sales.",
    },
    {
      number: 4,
      title: "Supplier & Purchasing",
      description:
        "Keep good records of suppliers, monitor lead times and purchase cycles. Improved management of suppliers will guarantee timely replenishment of the bestsellers.",
    },
    {
      number: 5,
      title: "Order Fulfillment",
      description:
        "When a book is sold or reserved, the system updates stock immediately, reducing overselling. This will ensure that customers are always provided with the right information on availability.",
    },
    {
      number: 6,
      title: "Reporting & Analysis",
      description:
        "Examine the trends in genres, authors, and prices to make improved stocking choices. Evidence-based information is used to maximize inventory investment and profit maximization.",
    },
  ],
};
...
export const BOOKSTORE_FAQS = [
  ...
  },
  {
    ...
    answer:
      "Yes. Shopping and online sales remain in touch, and there is real-time data-sharing across all branches. Stock, price, and sales are automated and updated across locations.",
  },
  {
    id: "4",
    question: "Can I manage discounts by author or genre?",
    answer:
      "Yes. Specific authors, genres or publishers can be discounted easily. The Bookstore POS Software simplifies the process of promotions and eliminates pricing errors.",
  },
  {
    id: "5",
    question: "Is the system easy for staff to use?",
    answer:
      "Yes. The software has a simple interface, quick billing and clear stock views. Employees can scan ISBN codes, sell packages, and examine stationery supplies within a short period of time without confusion.",
  },
];
...
export const BOOKSTORE_TESTIMONIAL_FEATURES = [
  ...
  },
  {
    ...
    description:
      "Customers like short queues and fast billing. The system manages ISBN codes and bundles easily.",
  ...
  },
  {
    ...
    description:
      "Detailed reports list sales by author, genre, or category. Real-time insights enable store owners to make smart decisions.",
  ...
  },
  {
    ...
    description:
      "All the branches are connected, and the orders are synchronised online. Stock and sales updates are done in all the locations in real-time.",
  ...
  },
  {
    ...
    description:
      "Our team is available 24/7. Onboarding and support make sure that stores run well on the first day.",

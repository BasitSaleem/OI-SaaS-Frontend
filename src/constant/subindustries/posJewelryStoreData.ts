...
export const JEWELRY_STORE_UNIFIED_CARDS: UnifiedPlatformCard[] = [
  ...
  },
  {
    ...
    description:
      "Gold, silver, diamonds, and gemstones change constantly. A good point-of-sale for a jewelry shop needs to automatically update pricing, calculate making charges and reduce human error so that everything is crystal clear.",
  },
  {
    id: "3",
    icon: "UnifiedIcon3",
    ...
    description:
      "When showcasing high-end inventory, retailers need a jewelry store POS system that enables user authentication, employee permissions, secure billing, and anti-fraud measures to protect each piece as if it were stored in an actual vault.",
  },
  {
    id: "4",
    icon: "UnifiedIcon4",
    ...
    description:
      "Whether they are engraving rings, resizing them or designing custom bridal sets, jewelry  stores deal in intimate and emotional transactions. Customization and repairs are a big part of the jewelry  business, but without a powerful POS system for jewelry stores to help manage them, operations can suffer.",
  },
  {
    id: "5",
    icon: "UnifiedIcon5",
    ...
    description:
      "Most retailers are still depending on non-real-time, traditional billing systems. A contemporary POS system for jewelry  stores includes dashboards, customer insights, purchase histories and margin monitoring.",
  },
];

export const JEWELRY_STORE_WHY_CHOOSE_CARDS = [
  {
    id: "1",
    icon: "whychoseIcon1",
  ...
  },
  {
    id: "2",
    icon: "whychoseIcon2",
    title: "Smart jewelry Billing",
    description:
      "The automatic calculation of weight, purity, and making charges, wastage, and tax calculations make sure that correct and prompt billing is generated every time. It minimizes errors in calculations and builds confidence in the customers.",
  },
  {
    id: "3",
    icon: "whychoseIcon3",
  ...
  },
  {
    id: "4",
    icon: "whychoseIcon4",
    title: "Repair & Custom Order Tracking",
    description:
      "Monitor customer repairs, resizing, polishing, and custom designs according to their due dates and status. This enhances transparency in the service and completeness of orders in time.",
  },
  {
    id: "5",
    icon: "whychoseIcon5",
    title: "Secure User Controls",
    description:
      "Cashiers, managers and owners have role-based access to protect sensitive data. It reduces internal risks as well as the complete operational security.",
  },
  {
    id: "6",
    icon: "whychoseIcon6",
    ...
    description:
      "Profit margins, stock value, top-selling designs and slow-moving items are clearly displayed in reports. The owner can make purchase plans and stock optimization with these insights.",
  },
];

export const JEWELRY_STORE_FEATURE_CARDS = [
  {
    id: "1",
  ...
  },
  {
    ...
    buttonColor: "#1AD1B9",
    list: [
      { listheading: "Live sales and inventory value" },
      { listheading: "Monitor metal usage and minimize wastage" },
      { listheading: "Find slow-moving and fast-moving designs" },
      { listheading: "Review profit margin by category and type of metal" },
    ],
  },
];

export const JEWELRY_STORE_KEY_FEATURES_CARDS = [
  {
    id: 1,
  ...
  {
    id: 9,
    title: "Staff Permissions & Audit Trails",
    description:
...
export const JEWELRY_STORE_WORKFLOW_DATA = {
  ...
  paragraph:
    "Our POS system for jewelry stores simplified complex handling and ensured price tracking of valuable items while reducing manual errors and stock discrepancies.",
  steps: [
    {
      number: 1,
      title: "Precious Inventory Procurement",
      description:
        "Jewelry store owners source products such as gold, diamonds, and custom pieces based on demand and customer preferences. Each item is carefully inspected for weight, purity, and certification. They are added to the system with detailed attributes like carat, stone type, and design category.",
    },
    {
      number: 2,
      title: "Categorization and Secure Storage",
      description:
        "All items are organized by type: rings, necklaces, and gemstones. They are further classified by metal, weight, or collection. Proper labeling and secure storage make it easy for staff to locate items quickly while maintaining strict control over high-value inventory.",
    },
    {
      number: 3,
      title: "Real-time Stock Monitoring",
      description:
        "Every action, such as sales, exchange repair, intake, or transfer, is recorded instantly. Owner inventory allows store owners to maintain accurate stock levels, avoid mismatches, and keep track of individual pieces, reducing the dependence on manual logs.",
    },
    {
      number: 4,
      title: "Vendor Management and Smart Purchasing",
      description:
        "The system manages multiple suppliers by tracking purchase orders, pricing variations, and delivery timelines. Owners can evaluate suppliers' reliability and ensure timely restocking of fast-selling or high-demand jewelry items.",
    },
    {
      number: 5,
      title: "Sales Processing and Order Handling",
      description:
        "When a product is sold, reserved, or customized, the inventory is updated automatically. The POS ensures accurate billing based on weight, making charges and taxes. It streamlines packaging and delivery for a smooth customer experience.",
    },
    {
      number: 6,
      title: "Insight and Performance Tracking",
      description:
        "Detailed reports provide clarity on the best-selling designs, dead stock, profit margins, and seasonal demands. These inventory insights help business owners make informed decisions about pricing, purchasing, and inventory optimization.",
    },
  ],
};
...
export const JEWELRY_STORE_FAQS = [
  ...
  },
  {
    ...
    answer:
      "Yes, our POS for jewelry  stores supports limitless branches that give you centralized control over stock, pricing, staff, reporting, and transfers across different locations. ",
  },
  {
    id: "3",
  ...
  },
  {
    ...
    answer:
      "Yes, all jewelry branches can be connected under one centralized dashboard for unified control.",
  },
];

export const JEWELRY_STORE_KEY_FEATURES = [
  {
    id: "jewelry-billing",
    title: "Jewelry Showroom Billing",
    description:
  ...
  {
    id: "jewelry-stock-control",
    title: "Real-Time Jewelry Stock",
    description:
  ...
  {
    id: "jewelry-vendor-mgmt",
    title: "Manufacturer & Supplier Management",
    description:
      "Keep track of all your jewelry suppliers, manage purchase orders, and monitor your shipment statuses effortlessly.",
    imageSrc:
  ...
  },
  {
    ...
    description:
      "Manage different jewelry styles, materials, and variants in one easy-to-navigate catalog system.",
    imageSrc:
  ...
  },
  {
    ...
    description:
      "Build relationships with your jewelry clients using integrated CRM tools to track their preferences and order history.",
  ...
  },
  {
    ...
    title: "Online Jewelry Integration",
    description:
      "Sync your physical showroom with your online jewelry store to manage all inventory and orders in one place.",
    imageSrc:
...
export const JEWELRY_STORE_TESTIMONIAL_DATA = {
  ...
  secondDescription:
    "Have total control over your stock of jewelry, sales and day to day running of your business with a system that is suited to the current jewelry business.",
  whyChooseTitle: "Why Choose Our System?",
  whyChooseDescription:
    "Jewelry stores have a POS system that allows them to have a clear control, accurate billing and safe inventory management, so that the daily operation is easy and consistent.",
};
...
export const JEWELRY_STORE_TESTIMONIAL_FEATURES = [
  {
    ...
    title: "Easy Setup",
    description:
      "Our interface is user-friendly, easy to learn and use and it can be installed within a very short time and with minimum interference to your jewelry business.",
  ...
  },
  {
    ...
    description:
      "Jewelry POS works when there are peak times, high-valued transactions and thus your billing counters will be consistent and efficient.",
  ...
  },
  {
    ...
    description:
      "Jewelry items are all organized according to weight, purity, design and category and hence inventory records are always accurate and properly arranged.",
  ...
  },
  {
    ...
    description:
      "Clear reports are provided with all the sales, stock valuation, profit margins, and best-selling designs that will enable sound decision-making.",
  ...
  },
  {
    ...
    description:
      "The jewelry POS system serves the gold, silver, diamond, platinum and gemstone business by adjusting itself to the day to day operations of your business.",
  ...
  },
  {
    ...
    title: "Safe Access",
    description:
      "The access of cashiers, managers and owners is role based user access so that the financial and inventory information is fully secured.",

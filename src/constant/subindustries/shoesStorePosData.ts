...
// ─── Shoes Store POS — UnifiedPlatform Section ──────────────────────────────
export const SHOES_STORE_UNIFIED_HEADING = "Challenges Faced by Shoe Stores";

export const SHOES_STORE_UNIFIED_PARAGRAPH ="Managing a footwear business comes with several operational difficulties that directly impact sales, efficiency, and customer satisfaction. Without a smart POS system, it becomes harder to control and scale with business growth.";

export const SHOES_STORE_UNIFIED_CARDS: UnifiedPlatformCard[] = [
   {
        id: "1",
        icon: "UnifiedIcon1",
        title: "Complicated Size & Style Variants",
        description:
            "Shoe stores deal with multiple sizes, designs, brands, and categories. In the absence of the right POS system to use in shoe stores, stock is disorganised, leading to the loss of sales and wasted inventory.",
    },
    {
        id: "2",
        icon: "UnifiedIcon2",
        ...
        description:
            "Customers abandon the store when there are long queues. Slow checkout is usually caused by manual searches or outdated POS systems.",
    },
    {
        id: "3",
        icon: "UnifiedIcon3",
        ...
        description:
            "Shoe retailers deal with exchanges and returns. In the absence of an appropriate POS system for footwear stores, tracking is cumbersome, and records are inaccurate.",
    },
    {
        id: "4",
        icon: "UnifiedIcon4",
        ...
        description:
            "Lack of inventory management poses a problem in the inter-store transfer of shoes. The result is lost stock and failure to meet customer demand.",
    },
    {
        id: "5",
        icon: "UnifiedIcon5",
        title: "Low Visibility of Top-Selling Products",
        description:
            "Without reports, it is difficult to identify best-selling shoes. This leads to poor purchasing decisions, unsold stocks, and lost opportunities.",
    },      
        
];

export const SHOES_STORE_WHY_CHOOSE_CARDS = [
    {
        id: "1",
        icon: "whychoseIcon1",
        title: "Real-Time Stock Accuracy",
        description:
            "The shoe store POS system will help keep track of all sizes and styles to ensure they have the right stock and will satisfy their customers more.",
    },
    {
        id: "2",
        icon: "whychoseIcon2",
        title: "Quick and Efficient Billing",
        description:
            "A convenient POS system in shoe stores with barcode scanning enables faster checkout and saves time.",
    },
    {
        id: "3",
        icon: "whychoseIcon3",
        ...
        description:
            "Our POS system helps manage suppliers, orders, and deliveries, making sure that stock is available when required.",
    },
    {
        id: "4",
        icon: "whychoseIcon4",
        ...
        description:
            "A single dashboard allows footwear stores to update prices, offers, and discounts across all outlets.",
    },
    {
        id: "5",
        icon: "whychoseIcon5",
        ...
        description:
            "Get clear reports in order to determine the best-selling shoes and minimize the slow-moving stock.",
    },
    {
        id: "6",
        icon: "whychoseIcon6",
        ...
        description:
            "A POS system for shoe stores allows control of all store inventory under one roof, keeping the stock consistent and synchronized across the branches.",
    },
];

export const SHOES_STORE_FEATURE_CARDS: FeatureCardData[] = [
    {
        id: "1",
    ...
    },
    {
        ...
        buttonColor: "#1AD1B9",
         list: [
            { listheading: "Detect slow-moving shoes, unbalanced pricing, and leakage of revenue"},
            { listheading: "Predict seasonal demand based on the previous trends and past sales"},
            { listheading: "Monitor branch-level performance in real time"},
        ]
    },
];

export const SHOES_STORE_KEY_FEATURES_CARDS = [
   {
        id: 1,
        ...
        imageSrc: "/assets/industries-pages/shoes-store-pos/key-features-section/key-feature-card1.webp",
    },
    {
        id: 2,
        ...
        imageSrc: "/assets/industries-pages/shoes-store-pos/key-features-section/key-feature-card2.webp",
    },
    {
        id: 3,
        ...
        imageSrc: "/assets/industries-pages/shoes-store-pos/key-features-section/key-feature-card3.webp",
    },
    {
        id: 4,
        ...
        imageSrc: "/assets/industries-pages/shoes-store-pos/key-features-section/key-feature-card4.webp",
    },
    {
        id: 5,
        ...
        imageSrc: "/assets/industries-pages/shoes-store-pos/key-features-section/key-feature-card5.webp",
    },
    {
        id: 6,
        ...
        imageSrc: "/assets/industries-pages/shoes-store-pos/key-features-section/key-feature-card6.webp",
    },
    {
        id: 7,
    ...
    {
        id: 8,
        title: "Intelligent Sales and Performance Reports",
        description:
        ...
        imageSrc: "/assets/industries-pages/shoes-store-pos/key-features-section/key-feature-card8.webp",
    },
    {
        id: 9,
        ...
        imageSrc: "/assets/industries-pages/shoes-store-pos/key-features-section/key-feature-card9.webp",
    },
    {
        id: 10,
        ...
        imageSrc: "/assets/industries-pages/shoes-store-pos/key-features-section/key-feature-card10.webp",
    },
];

export const SHOES_STORE_WORKFLOW_DATA = {
    heading: "Inventory Workflow of Owners’ POS",
    paragraph: "Our POS system of shoe stores has inventory processes that enable management to maintain accurate stock levels and categorize merchandise in terms of size and style.",
    steps: [
        {
            number: 1,
            title: "Inventory Acquisition",
            description: "Footwear stores have a POS system that captures the size, style, price, and supplier information when new shoes are added. This avoids the stock shortages and pricing mistakes."
        },
        {
            number: 2,
            title: "Stock Organization and Storage",
            description: "The POS system for shoe stores has well-defined inventory. Brand, category, and season sorting of products can be easily accessed."
        },
        {
            number: 3,
            title: "Inventory Tracking",
            description: "The POS system of shoe stores follows the movement of stock in real time on sales, returns, and transfers between branches.",
        },
        {
            number: 4,
            title: "Supplier and Purchasing",
            description: "The POS system also allows stores to control suppliers, purchase orders, and delivery schedules to make improved decisions on restocking of the shoe store.",
        },
        {
            number: 5,
            title: "Order Fulfillment",
            description: "The POS system is used to deal with orders in shoe stores. This guarantees proper delivery in terms of size and style, leading to fewer returns."
        },
         {
            number: 6,
            title: "Reporting and Analysis",
            description: "The best POS system of a shoe store is able to give reports on the best-selling goods, low stock, profits and branch operations to make smarter planning."
        },
...
export const SHOES_STORE_FAQS = [
    {
        id: "1",
        question: "What about sizes and styles in this POS system?",
        answer: "Our POS system of footwear stores tracks the individual sizes, styles and brands separately, ensuring that the stock remains updated and reduces error."
    },
    {
        id: "2",
        question: "Is it able to handle multiple branches?",
        answer: "Yes, it is inventory, sales, prices and reports that remain synchronized in all branches. The transfer of stock can take place on demand."
    },
    {
        id: "3",
        question: "Does the POS support returns and exchanges?",
        answer: "Yes, the returns and exchanges are handled effectively. Everything is documented so as to make sure that nothing is lost."
    },
    {
        id: "4",
        question: "Is it possible to integrate my online shop?",
        answer: "Yes, our shoe store POS system has online and retail inventory updated in real time. This avoids duplication and over-selling."
    },
    {
        id: "5",
...
export const SHOES_STORE_KEY_FEATURES = [
    ...
    },
    {
        ...
        description: "Keep track of all your shoes store manufacturers, manage purchase orders, and monitor your shipment statuses effortlessly.",
    ...
    },
    {
        ...
        description: "Manage different product styles, ingredients, and categories in one easy-to-navigate catalog system.",
    ...
    },
    {
        ...
        description: "Build relationships with your shoes store customers using integrated CRM tools to track their preferences and order history.",
    ...
    },
    {
        ...
        description: "Sync your physical store with your online shoes store to manage all inventory and orders in one place.",
...
export const SHOES_STORE_TESTIMONIAL_DATA = {
    ...
    secondHeading: "Keep Inventory Under Control",
    secondDescription: "Owners’ Inventory POS system helps shoe stores track all sizes, styles, and brands in real-time, enhances efficiency and reduces losses.",
    whyChooseTitle: "Why Choose Our POS System for Shoe Stores?",
    whyChooseDescription: "Our POS shoe store resolves the actual retail issues that include slow billing, confusion of variants, lack of stock match, and multi-branch management. It makes you work faster, organize and sell more confidently.",
};
...
export const SHOES_STORE_TESTIMONIAL_FEATURES = [
    ...
    },
    {
        ...
        description: "Quick checkout, scanning of barcodes and intelligent search minimizes queues. Your employees are efficient in their billing, clients are pleased and the sales increase.",
    ...
    
    {
        ...
        description: "Store preferences, purchase history and size preferences in the shoe store POS systems. This assists in controlling loyalty schemes and frequent purchases.",
...
export const SHOES_STORE_TOOLS_DATA = {
    heading: "Integration and Tools",
    paragraph: "Shoe brands need more than in-store billing. Our shoe store POS system is integrated with online stores, barcode scanners, payment gateways and warehouses. Connected tools minimize mistakes and maintain stock, sales, and funds across all channels and branches.",
    tools: [

...
export const BAKERY_WORKFLOW_DATA = {
  ...
  paragraph:
    "Owners Inventory automates your entire production and sales cycle. Every process, from purchasing raw materials through to managing counter sales and fulfilling cake orders are integrated into one system. The entire workflow is managed in real-time, without juggling notebooks and manual calculations.",
  steps: [
    {
      number: 1,
    ...
    },
    {
      ...
      description:
        "Planning and coordination are essential for custom cakes and events. When a preorder is placed, Owners Inventory records details, including the flavors, sizes, notes, delivery dates, and payment methods. All information is clearly documented, which eliminates the possibility of missing deadlines.",
    },
    {
      number: 5,
...
export const BAKERY_FAQS = [
  ...
  },
  {
    ...
    answer:
      "Yes, of course. With every sale, each ingredient is automatically updated. To prevent shortages during traffic hours, you can also set low-stock alerts.",
  },
  {
    id: "faq-small-bakeries",
    question: "Does the system work well for small bakeries?",
    answer:
      "Yes, it works well for both small and large setups. Because of its modular features, you can start small and grow big.",
  },
  {
    id: "faq-multi-branch",
...
export const BAKERY_TESTIMONIAL_DATA = {
  ...
  secondDescription:
    "With a modern POS designed for bakeries, you can take full control over ingredients, sales and custom orders.",
  whyChooseTitle: "Why Choose Owners Inventory for Your Bakery?",
  whyChooseDescription:
    "Owners Inventory was designed specifically to support bakery workflows. The system combines performance and simplicity so that you can concentrate on the baking process while it handles all the other operations.",
};
...
export const BAKERY_TESTIMONIAL_FEATURES = [
  {
    ...
    title: "Simple Setup",
    description:
      "Installing and configuring the system according to your bakery menu structure and ingredients is simple. It is easy to use and requires minimal training.",
  ...
  },
  {
    ...
    description:
      "The system is designed to perform well in busy environments. It works smoothly during morning rush hours and evening peak times. The billing process is fast and reliable, so customers can be served quickly.",
    icon: "testWhychoseIcon2",
  },
  {
    id: "clear-inventory-control",
    title: "Clear Inventory Control",
    description:
      "Each ingredient is accurately tracked in real-time. It is easy to know exactly what you have in stock and which products need replenishment.",
    icon: "testWhychoseIcon3",
  },
  {
    id: "reliable-reporting",
    title: "Reliable Reporting",
    description:
      "Simple and easy to understand reports are available that show sales, profit, ingredients used, and peak times. This information helps you to make better pricing and buying decisions.",
  ...
  },
  {
    ...
    description:
      "The system is flexible and adapts without any complexity to the growth of your business, whether you are a neighborhood baker or planning to expand to multiple locations.",
  ...
  },
  {
    ...
    title: "Safe Access",
    description:
      "Permissions based on roles protect confidential business data. Each of the cashiers, chefs, and managers has their own access control, which ensures security and discipline.",

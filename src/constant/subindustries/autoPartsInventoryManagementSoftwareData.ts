...
export const AUTO_PARTS_INVENTORY_UNIFIED_HEADING = "Challenges Auto Parts Businesses Face in Managing Inventory";

export const AUTO_PARTS_INVENTORY_UNIFIED_PARAGRAPH = "Most auto parts businesses deal with complex inventories that contain different vehicle parts, work with different suppliers, and operate across multiple locations. This makes it difficult to maintain consistent operational efficiency.";
...
export const AUTO_PARTS_INVENTORY_KEY_FEATURES_CARDS = [
    {
        ...
        imageSrc: "/assets/industries-pages/auto-parts-inventory-management-software/key-features-section/key-features-card1.webp",
    },
    {
        id: 2,
        ...
        imageSrc: "/assets/industries-pages/auto-parts-inventory-management-software/key-features-section/key-features-card2.webp",
    },
    {
        id: 3,
    ...
    },
    {
        ...
        imageSrc: "/assets/industries-pages/auto-parts-inventory-management-software/key-features-section/key-features-card4.webp",
    },
    {
        id: 5,
        ...
        imageSrc: "/assets/industries-pages/auto-parts-inventory-management-software/key-features-section/key-features-card5.webp",
    },
    {
        id: 6,
...
export const AUTO_PARTS_INVENTORY_WORKFLOW_DATA = {
    ...
    steps: [
        ...
        },
        {
            ...
            description: "The system handles bulk requests, retail transactions, and repair orders within a single workflow. Each order is processed with accurate part selection, ensuring compatibility. This improves efficiency in repair shops and ensures faster delivery for customers."
        },
        {
            number: 5,
...
export const AUTO_PARTS_INVENTORY_FAQS = [
    {
        ...
        answer: "The setup of the Owners Inventory is quite simple because of its navigation and easy-to-understand features. You can set up your automotive inventory quickly in the POS and start organizing data."
    },
    {
        id: "2",
        question: "Can I migrate my existing inventory data into the system?",
        answer: "Yes, Owners Inventory allows you to import existing data using Excel or CSV files. This helps you transfer data without manual entry."
    },
    {
        id: "3",
        question: "How does the system handle damaged or returned parts?",
        answer: "You can maintain records of returns, defective items, and adjustments separately, ensuring inventory accuracy while keeping proper reports for audits or supplier communication."
    },
    {
        id: "4",
...
export const AUTO_PARTS_INVENTORY_KEY_FEATURES = [
    {
        ...
        description: "Speed up your store sales with integrated billing and custom part number entry for a smoother customer experience.",
        imageSrc: "/assets/features-page/featurescard-banners/pos-banner.webp",
    },
    {
        id: "autoparts-stock-control",
        title: "Real-Time Parts Stock",
        description: "Know exactly what's in stock. Every part sold is instantly deducted from your inventory.",
    ...
    },
    {
        ...
        description: "Keep track of all your auto parts manufacturers, manage purchase orders, and monitor shipment statuses effortlessly.",
    ...
    },
    {
        ...
        description: "Manage different vehicle makes, models, and part variants in one easy-to-navigate catalog.",
    ...
    },
    {
        ...
        description: "Build relationships with your auto parts clients using integrated CRM tools to track their preferences and order history.",
    ...
    },
    {
        ...
        description: "Sync your physical store with your online auto parts store to manage all inventory and orders in one place.",
...
export const AUTO_PARTS_INVENTORY_TESTIMONIAL_DATA = {
    ...
    whyChooseDescription: "Owners Inventory is designed to support automotive store operations. It helps them manage complex inventory with different auto part variants, streamline workflows, and improve operational performance.",
};
...
export const AUTO_PARTS_INVENTORY_TESTIMONIAL_FEATURES = [
    {
        ...
        description: "Owners Inventory connects your shop, warehouses, and online channels, giving you a single platform to organize stocks while improving workflows.",
        icon: "testWhychoseIcon1",
    },
    {
        id: "2",
        title: "Real-time Stock Control",
        description: "It helps you monitor auto parts. The system sends alerts for low stock and automates replenishment, ensuring the availability of essential vehicle parts.",
        icon: "testWhychoseIcon2",
    },
    {
        id: "3",
        title: "Effective Management",
        description: "It helps you generate purchase orders based on customer demands and trends. It ensures that automotive parts are stocked and delivered without delays.",
        icon: "testWhychoseIcon3",
    },
    {
        id: "4",
        title: "Actionable Insights",
        description: "Owners Inventory helps automotive store owners make the right purchase decisions for restocking vehicle parts and plan inventory based on real-time data.",

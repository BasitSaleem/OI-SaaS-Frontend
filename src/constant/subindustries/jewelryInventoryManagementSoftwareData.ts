...
export const JEWELRY_INVENTORY_UNIFIED_HEADING = "Challenges Faced by Jewelry Stores Today";

export const JEWELRY_INVENTORY_UNIFIED_PARAGRAPH = "Items in jewelry stores require precise tracking to ensure everything is organized. Without an efficient Point of Sale system, it becomes difficult to keep stock records, which affects revenue negatively.";
...
export const JEWELRY_INVENTORY_KEY_FEATURES_CARDS = [
   
    {
        ...
        imageSrc: "/assets/industries-pages/jewelry-inventory-management-software/key-features-section/key-features-card1.webp",
    },
    {
        id: 2,
    ...
    },
     {
        ...
        imageSrc: "/assets/industries-pages/jewelry-inventory-management-software/key-features-section/key-features-card3.webp",
    }, 
    {
        id: 4,
    ...
    steps: [
        {
            ...
            description: "After stock intake, every jewelry item is registered according to its metal type, price, and design. They are assigned a unique identity for tracking. This process ensures that each item entering the store is properly documented and monitored consistently."
        },
        {
            number: 2,
            title: "Display Management",
        ...
        },
        {
            ...
            description: "Owners Inventory helps process orders according to customer requirements. When a jewelry product is sold or returned, the system updates stock instantly. It prevents order mismatch and maintains consistency between displayed items and system data."
        },
        {
            number: 4,
            title: "Custom Orders and Stock Allocation",
            description: "Custom orders with special engravings or designs are recoded separately while linking the required material. The system ensures that each custom item is handled exactly as the customers demand. It manages these orders without affecting available inventory and prevents stock confusion."
        },
        {
            number: 5,
...
export const JEWELRY_INVENTORY_FAQS = [
    ...
    },
    {
        ...
        answer: "The system tracks purchase orders, supplier details, and inventory flow, which helps create an accurate record of order fulfillment, returns, and repairs. It allows you to view supplier delivery times, stock quality, and pricing."
    },
    {
        id: "5",
        question: "How does it manage custom orders?",
        answer: "Owners Inventory manages custom orders effectively. It records all specifications, requirements, delivery dates, and payment details. It ensures that the order is completed accurately according to the customer's demand and delivered on time."
    },
];

export const JEWELRY_INVENTORY_KEY_FEATURES = [
    {
        id: "jewelry-billing",
    ...
    },
    {
        ...
        description: "Know exactly what's in stock. Every piece sold is instantly deducted from your inventory for both showroom and warehouse.",
    ...
    },
    {
        ...
        description: "Keep track of all your jewelry manufacturers, manage purchase orders, and monitor your shipment statuses effortlessly.",
        imageSrc: "/assets/features-page/featurescard-banners/purchases-banner.webp",
    },
    {
        id: "jewelry-variants",
        title: "Metal & Gemstone Tracking",
        description: "Manage different jewelry metals, gemstones, and variants in one easy-to-navigate catalog software.",
    ...
    },
    {
        ...
        description: "Monitor your jewelry showroom's financial health with detailed reports on sales, deposits, and operating expenses.",
        imageSrc: "/assets/features-page/featurescard-banners/finance-banner.webp",
    },
    {
        id: "jewelry-ecommerce",
        title: "Online Jewelry Store Integration",
...
export const JEWELRY_INVENTORY_TESTIMONIAL_FEATURES = [
    {
        ...
        description: "Every item in inventory is tracked to ensure accurate updates of the stock levels. The software keeps a record of every purchase detail to reduce the risk of loss.",
        icon: "testWhychoseIcon1",
    },
    {
        id: "2",
        title: "Support Custom and Repair Workflows",
        description: "The system ensures that every personalized order and repair request is documented correctly, which helps complete customer orders without missing any special requirements.",
        icon: "testWhychoseIcon2",
    },
    {
        id: "3",
        title: "Handles Multi-Source Inventory",
        description: "The stock from in-house production, suppliers, and consignments is managed in one place with separate reports. It makes it easy to count the items in inventory from different sources.",
    ...
    },
    {
        ...
        description: "Our software provides full control to the owners of jewelry stores. They can assign different roles to employees, limit access, maintain security, and keep an eye on the store’s activity while ensuring smooth daily operations.",

...
export const JEWELRY_INVENTORY_KEY_FEATURES = [
  ...
  },
  {
    ...
    description:
      "Know exactly what's in stock. Every piece sold is instantly deducted from your inventory for both showroom and warehouse.",
  ...
  },
  {
    ...
    description:
      "Keep track of all your jewelry manufacturers, manage purchase orders, and monitor your shipment statuses effortlessly.",
    imageSrc:
  ...
  },
  {
    ...
    description:
      "Manage different jewelry metals, gemstones, and variants in one easy-to-navigate catalog software.",
    imageSrc:
  ...
  },
  {
    ...
    description:
      "Monitor your jewelry showroom's financial health with detailed reports on sales, deposits, and operating expenses.",

...
export const HEALTHCARE_INVENTORY_UNIFIED_HEADING =
  "Challenges Healthcare Organizations Face Today";

export const HEALTHCARE_INVENTORY_UNIFIED_PARAGRAPH =
  "Managing healthcare inventory is complex because even small errors can impact patient care. Healthcare service providers face constant operational and compliance challenges, which make it difficult to have control over daily tasks.";
...
export const HEALTHCARE_INVENTORY_FEATURE_CARDS: FeatureCardData[] = [
  {
    ...
    description:
      "Owners Inventory connects healthcare providers across multiple sales and service channels. It maintains accurate records of whether medicines are issued from pharmacy counters, internal departments, or external requests. It updates stocks with every transaction.",
    subDescription:
    ...
    list: [
      ...
      },
      {
        ...
        listdescription:
          "The system updates stock levels when orders are placed through digital platforms and external requests. Every issued supply is recorded in the system to prevent over-issuing. This maintains consistent stock levels across channels without manual effort or errors in inventory records.",
      },
      {
        listheading: "Unified Dashboard",
        listdescription:
          "Our customizable healthcare inventory management software provides a single dashboard to monitor all activities. It ensures every department and order request stays synchronized. The dashboard displays information in an easy-to-understand way, which reduces confusion. You can manage every healthcare operation without switching between systems, which boosts productivity.",
      },
    ],
  },
  {
...
export const HEALTHCARE_INVENTORY_WORKFLOW_DATA = {
  ...
  paragraph:
    "Our healthcare inventory management system follows a simple workflow that helps healthcare teams manage inventory from procurement to usage. It ensures every medical supply is tracked accurately, reducing errors, improving visibility, and supporting smooth daily healthcare operations.",
  steps: [
    {
      number: 1,
    ...
    },
    {
      ...
      description:
        "Whenever medical supplies are issued or used, the system deducts the used quantity from the inventory. This maintains accurate tracking of consumption, prevents manual errors, and ensures awareness of available resources.",
    },
    {
      number: 4,
      title: "Alerts and Replenishment Management",
      description:
        "The system sends automatic alerts and notifications when item expiry dates are near or stock levels are low, which helps healthcare facilities reorder supplies and equipment on time to avoid shortages and wastage. It maintains the uninterrupted availability of essential healthcare inventory.",
    },
    {
      number: 5,
      title: "Performance Tracking",
      description:
        "The healthcare inventory management reports help staff analyze demand patterns. It helps in procurement planning and provides better control over medical supplies for long-term operational efficiency and cost management.",
    },
  ],
};
...
export const HEALTHCARE_INVENTORY_TESTIMONIAL_DATA = {
  ...
  secondDescription:
    "Every expired drug and missing supply carries real risk. Get a free demo of Owners Inventory today and learn how it keeps healthcare operations accurate, compliant, and fully in control.",
  whyChooseTitle:
    "Why Choose Owners Inventory for Healthcare Inventory Management?",
  whyChooseDescription:
    "Our inventory management software handles tasks efficiently where accuracy is crucial. It manages complex healthcare inventory with structured workflows and reduces the chances of human errors by eliminating manual processes.",
};
...
export const HEALTHCARE_INVENTORY_FAQS = [
  ...
  },
  {
    ...
    answer:
      "It maintains consistent records and minimizes manual intervention. This helps our inventory management system reduce mismatches between physical stock and recorded data over time.",
  },
  {
    id: "4",
    question: "Can multiple users access the system at the same time?",
    answer:
      "Yes, our inventory software supports multi-user access. It allows different team members to work collaboratively while maintaining data consistency and controlled usage.",
  },
  {
    id: "5",
    question:
      "Does the software support inventory management for multiple locations?",
    answer:
      "Yes, the system manages healthcare inventory across multiple facilities. It provides full control and oversight of inventory in different branches through a centralized dashboard. It improves coordination between healthcare organizations in different locations.",
  },
];
...
export const HEALTHCARE_INVENTORY_TESTIMONIAL_FEATURES = [
  {
    ...
    description:
      "It handles large volumes of varied medical supplies with structured categorization, making it easier for healthcare teams to organize large and complex inventories.",
  ...
  },
  {
    ...
    description:
      "Our healthcare management software manages batch-level details to improve supply traceability and ensure better handling of medicines across departments.",
  ...
  },
  {
    ...
    description:
      "It eliminates manual tracking and simplifies repetitive tasks, which helps staff focus on critical medical operations instead of managing inventory records.",
  ...
  },
  {
    ...
    description:
      "Owners Inventory keeps inventory information aligned across teams, helping different medical departments work consistently. It also reduces miscommunications and keeps stocks updated.",
  ...
  },
  {
    ...
    description:
      "The software is easy to use in healthcare environments. It ensures teams can efficiently manage medical inventory without extensive training or technical expertise.",

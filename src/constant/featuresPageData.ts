...
export const CORE_OPERATIONS_DATA = {
  ...
  paragraph:
    "Take full control of your day-to-day operations with tools designed to keep your business running seamlessly.",
  features: [
    {
      id: "pos-feature",
...
export const SMART_INTEGRATION_DATA = {
  heading: "Connected Production & Smart Integrations",
  paragraph:
    "Take control of your manufacturing workflows while keeping your business connected. You can manage production orders, bills of materials, and assembly processes effortlessly.",
  features: [
    {
...
export const TEAM_SECTION_DATA = {
  ...
  description:
    "Empower your team, build customer loyalty, and manage resources with ease.",
  wrapperClass:
    "bg-[var(--background-halfwhite)] rounded-[40px] py-10 lg:py-[100px] px-5 lg:px-[60px] mx-0",
};

export const FINANCE_SECTION_DATA = {
  title: "Finance & Reporting Made Simple",
  description:
    "Gain accurate insights, monitor growth, and manage your financials with precision.",
